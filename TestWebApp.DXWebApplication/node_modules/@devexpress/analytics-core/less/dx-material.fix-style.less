...
.dx-designer .dx-designer-viewport {
    ...
    .dxrd-parameters-edit-dialog .dx-popup-content .dxrd-parameters-content {
        ...
        .dx-treelist-action-container .dx-button-content{
            padding: 4px;
        }   
    }
}
.dx-overlay-wrapper .dxrdp-export-to-menu .dx-submenu {
    ...
    .dx-menu-items-container {
        ...
        .dx-menu-item .dxrd-preview-export-menu-item {
            padding: 6px 6px;
            height: 35px;
            width: 70px;
...
.dx-designer-viewport {
    .dxqb-designer .dxrd-right-panel .dxrd-properties-wrapper {
        .dxrd-treelist-search-panel-container {
            padding-bottom: 0;
        }
        .dx-field {
...
.dx-designer .dx-designer-viewport {
    ...
    .dx-treelist-item {
        ...
        .dx-treelist-collapsedbutton::before {
            margin-left: -6px;
            margin-top: -5px;
        }
