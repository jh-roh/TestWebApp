...
exports.determineConnectingPoints = exports.GRID_SIZE = exports.PointSide = void 0;
var PointSide;
(function (PointSide) {
...
function determineConnectingPoints(startObject, endObject) {
    ...
    if (endObject.leftConnectionPoint.location.x() > startObject.rightConnectionPoint.location.x() + exports.GRID_SIZE * 2) {
        result.start = startObject.rightConnectionPoint;
        result.end = endObject.leftConnectionPoint;
    }
    else if (startObject.leftConnectionPoint.location.x() > endObject.rightConnectionPoint.location.x() + exports.GRID_SIZE * 2) {
