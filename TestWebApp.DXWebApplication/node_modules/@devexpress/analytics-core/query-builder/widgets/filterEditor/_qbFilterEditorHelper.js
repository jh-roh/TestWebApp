...
exports._setQBFilterEditorHelperDefault = exports.QBFilterEditorHelperDefault = exports.QBFilterEditorHelper = void 0;
    ...
    function QBFilterEditorHelper(parametersMode) {
        ...
        if (parametersMode === parameterModelMeta_1.ParametersMode.ReadWrite) {
            ...
            _this.onEditorFocusOut = function (criteria) {
                ...
                var usesParameters = [];
                criteriaEnumeration_1.criteriaForEach(criteria, function (child) {
