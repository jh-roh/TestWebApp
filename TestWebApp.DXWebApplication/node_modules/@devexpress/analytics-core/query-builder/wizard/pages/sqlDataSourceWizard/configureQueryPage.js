...
function _registerConfigureQueryPage(factory, dataSourceWizardOptions) {
    factory.registerMetadata(pageId_1.SqlDataSourceWizardPageId.ConfigureQueryPage, {
        ...
        description: _localization_1.localizeWithUpdateLocalizationMethod('Create a query or select a stored procedure') || localization_utils_1.getLocalization('Create a query or select a stored procedure.', _localizationStringIds_1.StringId.WizardPageConfigureQuery)
    });
}
