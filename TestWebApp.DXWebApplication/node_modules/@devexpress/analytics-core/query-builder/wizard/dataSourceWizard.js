...
exports._createDataSourceWizard = exports._registerDataSourceWizardPages = exports.DataSourceWizard = exports.DataSourceWizardPageIterator = exports.DataSourceWizardSettings = exports._DataSourceWizardOptions = exports._DataSourceWizardOptionsBase = void 0;
...
var _DataSourceWizardOptionsBase = (function () {
    ...
    Object.defineProperty(_DataSourceWizardOptionsBase.prototype, "federationDataSourceAvailable", {
        get: function () {
...
var DataSourceWizardPageIterator = (function (_super) {
    ...
    DataSourceWizardPageIterator.prototype.getNextPageId = function (pageId) {
        if (!pageId && this._isMoreThanOneDataSourceTypeAvailable(this._dataSourceWizardOptions)) {
