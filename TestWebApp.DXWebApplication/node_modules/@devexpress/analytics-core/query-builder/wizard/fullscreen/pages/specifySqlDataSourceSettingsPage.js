...
exports._registerSpecifySqlDataSourceSettingsPage = exports.SpecifySqlDataSourceSettingsPage = void 0;
...
var SpecifySqlDataSourceSettingsPage = (function (_super) {
    ...
    SpecifySqlDataSourceSettingsPage.prototype.registerSections = function () {
        ...
        this._setSectionPosition(pageId_1.FullscreenDataSourceWizardSectionId.ChooseSqlConnectionPage, this._dataSourceWizardOptions.rtl ? _utils_2.WizardSectionPosition.TopRight : _utils_2.WizardSectionPosition.TopLeft);
        this._setSectionPosition(pageId_1.FullscreenDataSourceWizardSectionId.ConfigureQueryPage, this._dataSourceWizardOptions.rtl ? _utils_2.WizardSectionPosition.TopLeft : _utils_2.WizardSectionPosition.TopRight);
        this._setSectionPosition(pageId_1.FullscreenDataSourceWizardSectionId.ConfigureQueryParametersPage, this._dataSourceWizardOptions.rtl ? _utils_2.WizardSectionPosition.BottomLeft : _utils_2.WizardSectionPosition.BottomRight);
        this._setSectionPosition(pageId_1.FullscreenDataSourceWizardSectionId.ConfigureMasterDetailRelationshipsPage, this._dataSourceWizardOptions.rtl ? _utils_2.WizardSectionPosition.BottomRight : _utils_2.WizardSectionPosition.BottomLeft);
    };
