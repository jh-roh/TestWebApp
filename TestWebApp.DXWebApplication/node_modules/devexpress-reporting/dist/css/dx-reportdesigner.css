...
.dx-designer .dxrd-parameters-dialog .dxrd-parameters-content .dxrd-parameters-content-list-wrapper .dxrd-parameters-content-list .dx-treelist-item .dx-treelist-action-container .dx-button {
  margin-top: -3px;
}
...
.dx-designer .dxrd-localization-editor .dxrd-left-localization-panel .dxrd-localization-panel-header .dx-fieldset .dx-field .dx-icon {
  margin: 0;
}
