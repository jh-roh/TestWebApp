...
exports.ReportDataSourceService = void 0;
...
var ReportDataSourceService = (function () {
    ...
    ReportDataSourceService.federationDataSourceFromBase64 = function (base64, dependentDataSources) {
        return analytics_internal_1.ajax(settings_1.HandlerUri(), 'federationDataSourceFromBase64', encodeURIComponent(JSON.stringify({ base64: base64, dataSources: dependentDataSources })));
    };
    ReportDataSourceService.getFederationDataSourceBase64 = function (dataSource, dependentDataSources) {
        return analytics_internal_1.ajax(settings_1.HandlerUri(), 'getFederationDataSourceBase64', encodeURIComponent(JSON.stringify({ federationDataSourceJSON: JSON.stringify({ FederationDataSource: new analytics_utils_1.ModelSerializer().serialize(dataSource) }), dataSources: dependentDataSources })));
    };
