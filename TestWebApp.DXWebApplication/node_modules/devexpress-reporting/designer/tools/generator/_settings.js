...
exports.ReportDialogSettings = exports.WizardsInitializerSettings = void 0;
var analytics_utils_1 = require("@devexpress/analytics-core/analytics-utils");
var analytics_wizard_1 = require("@devexpress/analytics-core/analytics-wizard");
var $ = require("jquery");
var ko = require("knockout");
var _dataSourceActions_1 = require("../../actions/_dataSourceActions");
var _federationDataSourceEditor_1 = require("../../actions/_federationDataSourceEditor");
...
var WizardsInitializerSettings = (function () {
    function WizardsInitializerSettings(connectionStrings, wizardSettings, callbacks, rtl, dataSources) {
    ...
    WizardsInitializerSettings.prototype._doFinishCallback = function (data, connections) {
        ...
        else if (data.dataSourceType === analytics_wizard_1.DataSourceType.Federation) {
    ...
    WizardsInitializerSettings.prototype.createSqlDataSourceEditor = function (settings) {
        this.federationDataSourceEditor = new _federationDataSourceEditor_1.FederationDataSourceEditor(settings.dataSourceHelper, settings.dataSourceWizard, settings.model, settings.undoEngine, settings.fieldListProvider, settings.rtl, this.multipleQueriesWizardCallbacks);
    ...
    WizardsInitializerSettings.prototype.createMultipleQueriesWizardCallbacks = function (itemsProvider, model, state) {
        var _this = this;
        var fieldsCallback = function (request, dataSource) {
            _fieldListDataSourcesHelper_1.patchRequest(request, dataSource ? [dataSource] : _this.multiQueryWizardOptions.dataSources(), state());
        ...
        this.multipleQueriesWizardCallbacks = {
            ...
            federationDataSourceResultSchema: function (dataSource) { return _qBRequestWrapper_1.QBRequestWrapper().getFederationResultSchema(dataSource); },
