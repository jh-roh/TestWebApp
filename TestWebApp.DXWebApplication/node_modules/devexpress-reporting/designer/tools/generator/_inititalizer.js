...
exports.ReportDesignerInitializer = void 0;
...
var _utils_2 = require("../../../viewer/search/_utils");
...
var subreportViewModel_1 = require("../../controls/subreportViewModel");
...
var _settings_2 = require("./_settings");
var ReportDesignerInitializer = (function (_super) {
    ...
    ReportDesignerInitializer.prototype.getModel = function () {
    ...
    ReportDesignerInitializer.prototype.subscribeIncomeReport = function (report, reportUrl, dataSourceRefs) {
        ...
        this._addDisposable(report.subscribe(function (newValue) {
            ...
            _utils_3.updateDataSourceRefs(newModel, dataSourceRefs);
    ...
    ReportDesignerInitializer.prototype.addReportDialogs = function (func) {
        var _this = this;
        var settings = new _settings_2.ReportDialogSettings(this._designerCallbacks);
        func(settings);
    ...
    ReportDesignerInitializer.prototype.addErrorPanelViewModel = function (element, options) {
        var _this = this;
        this.addElement('errorPanelViewModel', function () {
            ...
            var errorPanel = new _errorPanelViewModel_1.ErrorPanelViewModel(__assign(__assign({}, options), { controlScrollingTool: _this.buildingModel.controlScrollingTool, controlsHelper: _this.buildingModel.controlsHelper, editableObject: _this.buildingModel.editableObject, selection: _this.buildingModel.selection, undoEngine: function () { return _this.buildingModel.undoEngine(); }, onClick: function () {
                    if (!_this.buildingModel.designMode()) {
            ...
            _this._addDisposable(_this._reportcontext.subscribe(function (newVal) {
                ...
                if (newVal != null) {
                    ...
                    errorPanel._providers.forEach(function (provider) { return provider.collectErrors(); });
                }
            }));
            var $root = $(element);
            var $window = $(window);
    ...
    ReportDesignerInitializer.prototype.addFlagsAndInitProperties = function (element) {
        ...
        this.addElement('updateFont', function () { return function (values) {
            analytics_widgets_internal_1.availableFonts(__assign(__assign({}, analytics_widgets_internal_1.availableFonts()), values));
        }; });
        ...
        if (!element)
            return this;
        this.addElement('fullScreen', function () { return _utils_1.createFullscreenComputed(element, _this); });
    ...
    ReportDesignerInitializer.prototype.addPreview = function (options) {
        ...
        _initializer_1.createPreview({
            ...
            callbacks: __assign(__assign({}, options.callbacks), { _onGetBuildStatus: errorsAction, _onGetDocumentDetails: errorsAction })
        })
    ...
    ReportDesignerInitializer.prototype.initializeFieldListActionProviders = function (func) {
        ...
        if (func === void 0) { func = function () {
            ...
            if (_this._federationDataSourceEditor)
                providers.push(_this._federationDataSourceEditor);
    ...
    ReportDesignerInitializer.prototype.addControlProperties = function (editors, groups, accessibilityProvider) {
        _super.prototype.addControlProperties.call(this, editors, groups, this._accessibilityProvider);
        return this;
    };
    ...
    ReportDesignerInitializer.prototype._createExpressionsTab = function (context) {
        ...
        this._addDisposable(expressionTab.active.subscribe(function (newVal) {
            if (newVal && expressionTab.visible()) {
                _this.buildingModel.controlsStore.setFilter(_utils_3.isControl);
            }
            else {
                _this.buildingModel.controlsStore.setFilter(_utils_3.isNotParameter);
            }
        }));
    ...
    ReportDesignerInitializer.prototype.initializeUIEffects = function (applyBindings, element) {
        ...
        var updateSurfaceContentSizeLocalizationMode__ = _utils_3.updateSurfaceContentSizeLocalizationMode(this.buildingModel.surfaceSize, element, this.rtl);
            ...
            reportWizard.start(function (reportWizardState) {
                ...
                var createReport = function (wizardState) {
                    ...
                    _reportWizardService_1.ReportWizardService.generateReportFromWizardState(wizardState, reportWizard._requestModelType, state(), function (wizardModel) {
                        ...
                        designerModel.isDirty(true);
                        var newReport = _utils_3.createReportViewModel(result, designerModel.model());
        ...
        return (function (actions) {
            ...
            if (_settings_1.reportStorageWebIsRegister()) {
                actions.push({
                    ...
                    clickAction: function () {
                        designerModel.navigateByReports.addTab(new xrReport_1.ReportViewModel(subreportViewModel_1.SubreportViewModel.defaultReport), ko.observable(''));
                        designerModel.isDirty(true);
                    }
                });
    ...
    ReportDesignerInitializer.prototype.addParts = function (func) {
        ...
        if (func === void 0) { func = function (parts) {
            ...
            parts.push.apply(parts, __spreadArray([{ id: analytics_internal_1.DesignerBaseElements.GroupedToolbox, templateName: analytics_internal_1.DesignerBaseElements.GroupedToolbox, model: _this.buildingModel },
                ...
                { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.Parameters, model: _this.buildingModel.parameters }], _this._converters.map(function (model) { return { id: null, templateName: reportDesignerElements_1.ReportDesignerElements.ReportConverterDialog, model: model }; })));
            return parts;
        }; }
    ...
    ReportDesignerInitializer.prototype.tryAddFederationDataSourceEditorAddon = function (relationsEditor, manageQueriesEditor, queriesPopupHelper) {
        if (relationsEditor === void 0) { relationsEditor = this._federationDataSourceEditor.relationsEditor; }
        if (manageQueriesEditor === void 0) { manageQueriesEditor = this._federationDataSourceEditor.manageQueriesEditor; }
        if (queriesPopupHelper === void 0) { queriesPopupHelper = this._federationDataSourceEditor.queriesPopupHelper; }
        if (relationsEditor)
            this.buildingModel.addOns.push({ id: reportDesignerElements_1.ReportDesignerAddOns.MasterDetailEditor, templateName: reportDesignerElements_1.ReportDesignerAddOns.MasterDetailEditor, model: relationsEditor });
        if (manageQueriesEditor)
            this.buildingModel.addOns.push({ id: reportDesignerElements_1.ReportDesignerAddOns.FederatedManageQueriesEditor, templateName: reportDesignerElements_1.ReportDesignerAddOns.FederatedManageQueriesEditor, model: manageQueriesEditor });
        if (queriesPopupHelper)
            this.buildingModel.addOns.push({ id: reportDesignerElements_1.ReportDesignerAddOns.FederatedQueriesPopups, templateName: reportDesignerElements_1.ReportDesignerAddOns.FederatedQueriesPopups, model: queriesPopupHelper });
        return this;
    };
    ...
    ReportDesignerInitializer.prototype.configureReportStorageRegistration = function (reportStorageIsRegister, allowMDI) {
        _settings_1.reportStorageWebIsRegister(reportStorageIsRegister === undefined ? _settings_1.reportStorageWebIsRegister() : reportStorageIsRegister);
        this._allowMDI = _settings_1.reportStorageWebIsRegister() ? allowMDI : false;
        return this;
    };
    ...
    ReportDesignerInitializer.prototype.initCultureInfo = function (cultureInfoList) {
        $.extend(true, _utils_1.cultureInfo, cultureInfoList);
        return this;
    };
    ...
    ReportDesignerInitializer.prototype.addWizards = function (connectionStrings, wizardSettings, cusomizeSettingsFunc) {
        var _this = this;
        var usedDataSources = ko.pureComputed(function () {
            var dataSources = _this.buildingModel.dataSourceHelper() && _this.buildingModel.dataSourceHelper().usedDataSources();
            return dataSources && dataSources.filter(function (x) { return !!x.data; });
        });
        this._disposables.push(usedDataSources);
        var initializerSettings = new _settings_2.WizardsInitializerSettings(connectionStrings, wizardSettings, this._designerCallbacks, this.rtl, usedDataSources);
