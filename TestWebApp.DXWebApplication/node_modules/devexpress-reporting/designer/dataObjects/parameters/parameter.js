...
var editorTemplates_1 = require("../../../viewer/widgets/editorTemplates");
var _localizationUtils_1 = require("../../controls/utils/_localizationUtils");
var editorTemplates_2 = require("../../widgets/editorTemplates");
...
var EditableParameterMode = {
    ...
    _displayNamePatcher: {
        'isMultiValue': function (info) {
            info.displayName = 'Allow multiple values';
            info.localizationId = 'ReportDesignerStringId.NewParameterEditor_AllowMultipleValues';
        },
        'allowNull': function (info) {
            info.displayName = 'Allow null value';
            info.localizationId = 'ReportDesignerStringId.NewParameterEditor_AllowNull';
        },
        'selectAllValues': function (info) {
            info.displayName = 'Select all values';
            info.localizationId = 'ReportDesignerStringId.NewParameterEditor_SelectAllValues';
        },
...
var Parameter = (function (_super) {
    ...
    function Parameter(model, _report, serializer) {
        ...
        _this.labelOrientation = ko.observable('Horizontal');
        ...
        _this._showLayoutProperties = ko.observable(false);
        ...
        if (this._isEditing()) {
            info.forEach(function (x) {
                if (EditableParameterMode._ignoreEditors.indexOf(x.propertyName) !== -1) {
                    ...
                    x.editor = editorTemplates_2.designerEditorTemplates.getEditor('parametersCheckbox');
                }
                else if (x.editor && x.editor.custom === editorTemplates_1.viewerEditorTemplates.multiValueEditable.custom) {
    ...
    Parameter.prototype.getInfo = function () {
        ...
        if (this.type) {
            ...
            newInfo.splice(newInfo.indexOf(newInfo.filter(function (prop) { return prop.propertyName === 'description'; })[0]) + 1, 0, layoutItems_1.labelOrientation);
    ...
    Parameter.prototype.isPropertyVisible = function (name) {
        ...
        else if (name == layoutItems_1.labelOrientation.propertyName) {
