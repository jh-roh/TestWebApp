...
exports.WrappedExpressionOptions = void 0;
...
var WrappedExpressionOptions = (function (_super) {
    ...
    function WrappedExpressionOptions(options, handlers, fieldListProvider, eventName) {
        ...
        _this._disposables.push(ko.computed(function () {
            ...
            try {
                ...
                if (!_this.value())
                    return;
                analytics_criteria_utils_1.CriteriaOperatorStateMachine.parse(_this.value());
    ...
    WrappedExpressionOptions.prototype.onContentReady = function (e) { };
