...
exports.JSReportDesignerBinding = void 0;
...
var _initializer_2 = require("./internal/_initializer");
...
var JSReportDesignerBinding = (function (_super) {
    ...
    JSReportDesignerBinding.prototype._createModel = function (initData, element) {
        ...
        return _initializer_2.createReportDesignerFromModel(initData, element, this._callbacks, false);
    };
