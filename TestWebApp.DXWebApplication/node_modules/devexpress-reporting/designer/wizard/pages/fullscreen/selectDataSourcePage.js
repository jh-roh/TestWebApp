...
exports._registerSelectDataSourcePage = exports.SelectDataSourcePage = void 0;
...
var SelectDataSourcePage = (function (_super) {
    ...
    SelectDataSourcePage.prototype.registerSections = function () {
        ...
        if (this.reportWizardOptions.dataSources().length > 0 && this.reportWizardOptions.canCreateDataSource) {
            this._setSectionPosition(pageId_1.FullscreenReportWizardSectionId.ChooseAvailableDataSourcePage, analytics_wizard_internal_1.WizardSectionPosition.Top);
            this._setSectionPosition(pageId_1.FullscreenReportWizardSectionId.ChooseDataSourceTypePage, analytics_wizard_internal_1.WizardSectionPosition.Bottom);
        }
    };
