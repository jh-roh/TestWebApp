...
exports._registerConfigureCrossTabPage = exports.ConfigureCrossTabPage = exports.SelectCrossTabDataMember = void 0;
...
var SelectCrossTabDataMember = (function (_super) {
    ...
    function SelectCrossTabDataMember(_fieldListCallBack, _hideDataMemberSubItems) {
        ...
        _this._disposables.push(_this._controller.dragDropHandler = new _crossTabDragUtils_1.CrossTabWizardDragDropHandler({
            dragHelperContent: _this._dragHelperContent,
            parent: '.dx-designer-viewport .dx-fullscreen-wizard',
            containment: '.dxrd-report-wizard',
            target: '.dxrd-wizard-page',
            addHandler: function (dropTarget, name) {
