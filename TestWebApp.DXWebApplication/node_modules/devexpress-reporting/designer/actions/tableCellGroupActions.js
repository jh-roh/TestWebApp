...
exports.TableCellGroupActions = void 0;
...
var TableCellGroupActions = (function (_super) {
    ...
    function TableCellGroupActions(selectionProvider) {
        ...
        _this._distributeColumnsAction = {
            group: function () { return analytics_utils_1.getLocalization('Table Cells', 'ASPxReportsStringId.ReportDesigner_PageGroup_TableCells'); },
    ...
    TableCellGroupActions.prototype._calculateMinimalHeight = function (cell) {
        return Math.max.apply(Math, __spreadArray([this._calculateTextHeight(cell) + this._calculateBordersHeight(cell) + this._calculatePaddingsHeight(cell)], cell.controls().map(function (control) { return control.location.y() + control.size.height(); })));
    };
