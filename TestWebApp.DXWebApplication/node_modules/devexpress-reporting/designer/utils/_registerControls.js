...
var xrControl_1 = require("../controls/metadata/xrControl");
var xrCrossband_1 = require("../controls/metadata/xrCrossband");
var xrCrossTab_1 = require("../controls/metadata/xrCrossTab");
...
var _headOrFooterBandType_1 = require("../controls/utils/_headOrFooterBandType");
...
var xrControl_2 = require("../controls/xrControl");
var xrCrossband_2 = require("../controls/xrCrossband");
var xrCrossTab_2 = require("../controls/xrCrossTab");
...
var xrReport_2 = require("../controls/xrReport");
...
function registerControls(fieldListProvider) {
    ...
    settings_1.controlsFactory().registerControl('Unknown', {
        ...
        nonToolboxItem: true,
        surfaceType: xrControl_2.XRControlSurface
    });
    settings_1.controlsFactory().registerControl('XRLabel', {
        ...
        type: xrControl_2.XRControlViewModel,
    ...
    settings_1.controlsFactory().registerControl('XRPanel', {
        info: xrControl_1.panelSerializationsInfo,
        toolboxIndex: 4,
        group: 'common',
        defaultVal: {
            '@SizeF': '300,75'
    ...
    settings_1.controlsFactory().registerControl('XRCrossTab', {
        info: xrCrossTab_1.crossTabSerializationInfo,
        toolboxIndex: 14,
        type: xrCrossTab_2.XRCrossTabViewModel,
        group: 'complex',
        defaultVal: {
        ...
        surfaceType: xrCrossTab_2.XRCrossTabSurface,
    ...
    settings_1.controlsFactory().registerControl('XRCrossTabCell', {
        ...
        popularProperties: xrCrossTabCell_1.popularPropertiesCrossTabCell,
        nonToolboxItem: true,
        isDeleteDeny: true,
        group: 'complex',
        defaultVal: {
    ...
    settings_1.controlsFactory().registerControl('XRSubreport', {
        ...
        defaultVal: {
            '@SizeF': '100,23',
            'ReportSource': subreportViewModel_1.SubreportViewModel.defaultReport
        },
    ...
    settings_1.controlsFactory().registerControl('XRTableOfContents', {
        ...
        canDrop: function (dropTarget, dragFrom) {
            ...
            else if (_headOrFooterBandType_1.isHeaderOrFooterBandType(bandModel)) {
    ...
    settings_1.controlsFactory().registerControl('DevExpress.XtraReports.UI.XtraReport', {
        info: xrReport_1.reportSerializationInfo,
        nonToolboxItem: true,
        surfaceType: xrReport_2.ReportSurface,
        popularProperties: xrReport_1.popularPropertiesReport,
        isCopyDeny: true,
        isDeleteDeny: true,
