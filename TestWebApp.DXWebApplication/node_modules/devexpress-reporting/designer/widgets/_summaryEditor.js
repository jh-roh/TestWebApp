...
exports.SummaryEditorModel = exports.SummaryEditorPopup = void 0;
        ...
        this.buttons = [
            {
                ...
                options: {
                    text: analytics_utils_1.getLocalization('Apply', ''), type: 'default', stylingMode: 'contained',
                    onClick: function () {
...
var SummaryEditorModel = (function (_super) {
    ...
    SummaryEditorModel.prototype._initExpressionValues = function () {
        ...
        try {
            var expression = analytics_criteria_utils_1.CriteriaOperatorStateMachine.parse(textBinding);
