...
exports.StylesEditorHeaderModel = void 0;
...
var style_2 = require("../controls/properties/style");
var StylesEditorHeaderModel = (function () {
    function StylesEditorHeaderModel(styleName, styles, disabled, popupContainer) {
        ...
        this.items = ko.pureComputed(function () {
            var result = [new style_2.StyleModel({ '@Name': analytics_utils_1.getLocalization(StylesEditorHeaderModel.newItem, StylesEditorHeaderModel.newItemTextId) })];
            if (styles && styles()) {
        ...
        this.onValueChanged = function (e) {
            if (e.value === analytics_utils_1.getLocalization(StylesEditorHeaderModel.newItem, StylesEditorHeaderModel.newItemTextId)) {
                var newStyleName = analytics_internal_1.getUniqueNameForNamedObjectsArray(styles(), 'xrControlStyle'), newStyle = new style_2.StyleModel({ '@Name': newStyleName });
...
ko.bindingHandlers['dxStylesEditor'] = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        ko.applyBindings(bindingContext.createChildContext(new analytics_widgets_1.ObjectProperties(style, { editors: style_1.styleSerializationInfo }, 1, viewModel.disabled, undefined, viewModel.textToSearch)), $element.children()[0]);
