...
exports.ReportExpressionEditorWrapper = void 0;
...
var ReportExpressionEditorWrapper = (function (_super) {
    ...
    function ReportExpressionEditorWrapper(control, value) {
        ...
        var self = _this;
        _this.resizeHelper = new analytics_widgets_internal_1.ResizeHelper();
        _this.buttonItems.push({ toolbar: 'bottom', location: 'after', widget: 'dxButton', options: { text: analytics_utils_1.getLocalization('Apply', 'StringId.Apply'), type: 'normal', stylingMode: 'contained', onClick: function (sender) { self.apply(sender); } } });
        return _this;
    }
    ReportExpressionEditorWrapper.prototype.save = function (sender) {
        this.apply(sender) && _super.prototype.save.call(this);
    };
    ...
    ReportExpressionEditorWrapper.prototype.updateExpression = function (expression) {
        this.adapter() && this.adapter().dispose();
        this.adapter(new reportExpressionEditorAdapter_1.ReportExpressionEditorAdapter(ko.observable(expression['serializationInfo'] && expression['serializationInfo']['valuesArray'] || []), ko.observable(__assign(__assign({}, expression), {
            value: this.currentProperty.value
        }))));
    };
    return ReportExpressionEditorWrapper;
}(analytics_widgets_internal_1.PopupEditorBase));
