...
exports.XRCrossTabSurface = exports.CrossTabDataFieldModel = exports.CrossTabFieldModel = exports.CrossTabLayoutOptionsModel = exports.XRCrossTabViewModel = void 0;
...
var defenitions_2 = require("./metadata/crosstab/defenitions");
...
var style_2 = require("./properties/style");
...
var XRCrossTabViewModel = (function (_super) {
    ...
    function XRCrossTabViewModel(model, parent, serializer) {
        ...
        _this._rowDefinitions = _this._getArray(defenitions_1.CrossTabRowDefinitionsModel, model, 'RowDefinitions', serializer);
        _this._columnDefinitions = _this._getArray(defenitions_1.CrossTabColumnDefinitionsModel, model, 'ColumnDefinitions', serializer);
        _this.cells = _this._getArray(xrCrossTabCell_1.XRCrossTabCellViewModel, model, 'Cells', serializer);
        _this.controlParameters = analytics_utils_1.deserializeArray(model['Parameters'], function (item) { return new controlParameter_1.ControlParameter(item, serializer, _this.root.dataSourceHelper, _this.root.dataBindingsProvider); });
    ...
    XRCrossTabViewModel.prototype._initStyles = function (root) {
        var _this = this;
        if (root && root.styles) {
            style_1.crossTabStyles.forEach(function (style) {
                var styleName = _this[style.propertyName]();
                if (!styleName) {
                    var newStyle = new style_2.StyleModel(style_1.crossTabStylesDefaults[style.propertyName]);
    ...
    XRCrossTabViewModel.prototype._calcSize = function (defenition) {
        ...
        defenition.forEach(function (element) {
            result += element[(element instanceof defenitions_1.CrossTabColumnDefinitionsModel ? 'width' : 'height')]();
        });
        return result;
    };
    ...
    XRCrossTabViewModel.prototype.updateLayout = function () {
        ...
        undo && undo.start();
        this.update(true);
        this.defenitionUpdater = new defenitions_1.DefenitionUpdater(this);
        ...
        var defs = this.defenitionUpdater.update(modelCells, defenitions_2.crossTabCellWidth.defaultVal, defenitions_2.crossTabCellHeight.defaultVal);
    ...
    XRCrossTabViewModel.prototype.getFields = function () {
        ...
        this.getInfo = function () {
            info.forEach(function (item) {
                ...
                if (item.propertyName === 'rowFields' || item.propertyName === 'columnFields')
                    ...
                    item.addHandler = function () { return new controlParameter_1.ControlParameter({}, new analytics_utils_1.ModelSerializer(), _this.root.dataSourceHelper, _this.root.dataBindingsProvider); };
                if (type)
    ...
    XRCrossTabViewModel.prototype.applyCells = function (cellsInfo, initOnly) {
        ...
        cellsInfo.forEach(function (cell, index) {
            ...
            if (initOnly)
                currentCell = defenitions_1.findcells(_this.cells(), cell._columnIndex(), cell._rowIndex())[0];
            else
    ...
    XRCrossTabViewModel.prototype.customizeExpressionCategories = function (tools, categories) {
        var fieldsCategory = categories.filter(function (item) { return item.content.name == 'dx-expressioneditor-fields'; })[0];
...
var XRCrossTabSurface = (function (_super) {
    ...
    XRCrossTabSurface.prototype.selectLine = function (selection, cell, isMultiSelect, isRow) {
        ...
        var cells;
        if (isRow)
            cells = defenitions_1.findcells(model.cells(), null, cell._rowIndex());
        else
            cells = defenitions_1.findcells(model.cells(), cell._columnIndex());
