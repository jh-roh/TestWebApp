...
exports.XRTableCellSurface = exports.XRTableCellViewModel = void 0;
...
var XRTableCellSurface = (function (_super) {
    ...
    XRTableCellSurface.prototype._getAdjacentCellByRowIndex = function (rowIndex) {
        ...
        return nextRow && nextRow.cells && nextRow.cells().filter(function (cell) { return Math.round(cell.left() - _this._control.left()) === 0; })[0];
    };
