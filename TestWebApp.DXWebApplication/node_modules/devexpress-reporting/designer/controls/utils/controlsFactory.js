...
var ControlsFactory = (function (_super) {
    ...
    ControlsFactory.prototype.hideExpressionBindings = function (type) {
        ...
        (_a = this._expressionWrapper).hidePropertyDescriptions.apply(_a, __spreadArray([type], propertyNames));
    };
    ControlsFactory.prototype.hidePropertyDescriptions = function (type) {
        ...
        return this.hideExpressionBindings.apply(this, __spreadArray([type], propertyNames));
    };
