...
exports.createChartDesignerOptions = void 0;
var analytics_internal_1 = require("@devexpress/analytics-core/analytics-internal");
var analytics_tools_1 = require("@devexpress/analytics-core/analytics-tools");
var analytics_utils_1 = require("@devexpress/analytics-core/analytics-utils");
var ko = require("knockout");
var createChartDesignerOptions = function (designerModel, dataSourceHelper, model, parameters, chartValueBindingProvider) {
    ...
    var chartDesignerOptions = {
        ...
        buttons: [{
                ...
                options: {
                    text: analytics_utils_1.getLocalization('OK', 'PivotGridStringId.FilterOk'), type: 'default', stylingMode: 'contained',
                    onClick: function () {
                        chartIsDirty(false);
            ...
            },
            {
                toolbar: 'bottom', location: 'after', widget: 'dxButton',
                options: {
                    text: analytics_utils_1.getLocalization('Cancel', 'AnalyticsCoreStringId.SearchDialog_Cancel'), type: 'normal', stylingMode: 'contained',
                    onClick: function () {
                        chartDesignerOptionsVisible(false);
                    }
                }
...
exports.createChartDesignerOptions = createChartDesignerOptions;
