...
exports.XRReportElementViewModel = void 0;
...
var _headOrFooterBandType_1 = require("./utils/_headOrFooterBandType");
...
var XRReportElementViewModel = (function (_super) {
    ...
    XRReportElementViewModel.prototype.addChild = function (control) {
        if (control.controlType === 'XRTableOfContents' && !_headOrFooterBandType_1.isHeaderOrFooterBandType(this)) {
            ...
            if (band) {
                if (_headOrFooterBandType_1.isHeaderOrFooterBandType(band)) {
    ...
    Object.defineProperty(XRReportElementViewModel.prototype, "root", {
        get: function () {
    ...
    XRReportElementViewModel.prototype.customizeExpressionCategories = function (sender, categories) { };
