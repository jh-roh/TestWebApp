...
exports.sortBySummaryConditionInfo = exports.sortBySummaryInfo = exports.customTotalSummaryType = exports.field = exports.conditions = exports.fieldComponentName = exports.summaryType = exports.summaryTypeValues = void 0;
...
exports.customTotalSummaryType = {
    ...
    defaultVal: '', editor: analytics_widgets_1.editorTemplates.getEditor('combobox'),
    valuesArray: [{ value: '', displayValue: '(none)', localizationId: 'ChartStringId.WizNoBackImage' }].concat(exports.summaryTypeValues)
};
