...
exports.ReportSurface = exports.ReportViewModel = void 0;
...
var _localizationEngine_1 = require("../localization/_localizationEngine");
...
var ReportViewModel = (function (_super) {
    ...
    function ReportViewModel(report, serializer) {
        ...
        _this.parameterHelper = new reportParameterHelper_1.ReportParameterHelper(_this);
        ...
        _this.parameterPanelLayoutItems = analytics_utils_1.deserializeArray(report.ParameterPanelLayoutItems, function (item) { return layoutItems_1.ParameterPanelLayoutItem.createLayoutItem(item, _this, serializer); });
        _this.parameterHelper.updateParameterLayoutItems();
        ...
        _this._disposables.push(_this._localization = new _localizationEngine_1.ReportLocalizationEngine(_this));
    ...
    ReportViewModel.createObjectStorage = function (_componentStorage, _objectStorage, collectSubscription) {
        ...
        var objectStorage = ko.observableArray(__spreadArray(__spreadArray([], _objectStorage()), _componentStorage()));
    ...
    ReportViewModel.prototype._initializeBands = function () {
        var traverse = function (xs) { return xs.reduce(function (res, x) { res.push.apply(res, __spreadArray([x], traverse(ko.unwrap(x['bands']) || []))); return res; }, []); };
