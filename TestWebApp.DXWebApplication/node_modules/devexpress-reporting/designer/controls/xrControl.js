...
exports.XRControlSurface = exports.XRControlSurfaceBase = exports.XRControlViewModel = void 0;
...
var XRControlSurfaceBase = (function (_super) {
    ...
    XRControlSurfaceBase.prototype._isThereIntersectionWithUsefulArea = function (useFullWidth) {
        var absoluteRect = this._unitAbsoluteRect;
    ...
    XRControlSurfaceBase.prototype.checkParent = function (surfaceParent) {
        var thisParent = this.parent instanceof xrBand_1.BandSurface || this.parent && this.parent._control.controlType === 'DevExpress.XtraReports.UI.XtraReport' ? null : this.parent;
        var anotherParent = surfaceParent instanceof xrBand_1.BandSurface || this.parent && this.parent._control.controlType === 'DevExpress.XtraReports.UI.XtraReport' ? null : surfaceParent;
    ...
    XRControlSurfaceBase.prototype.isThereIntersectionWithUsefulArea = function () {
        ...
        if (_container instanceof xrBand_1.BandSurface && _container['_unitAbsoluteRect']) {
            var absoluteRect = this.container()['_unitAbsoluteRect'];
            ...
            var root = this.getRoot(), usefulPageWidth = root['_unitAbsoluteRect'].width;
