...
exports.XRPictureBoxSurface = exports.XRPictureBoxViewModel = void 0;
    ...
    function XRPictureBoxSurface(control, context) {
        ...
        _this._disposables.push(_this.contentCss = ko.pureComputed(function () {
            ...
            var urlContent = imageSource
                ...
                : control.imageUrl();
            return analytics_internal_1.extend({}, _this._createBackimage(control['backColor'](), urlContent, control.sizing(), control.isSmallerImage()), _this._createBackgroundOrigin(), control.isAlignmentDisabled() ? {} : _this._createBackgroundPosition(control.imageAlignment(), control.sizing()), _this.cssCalculator.createVerticalAlignment('Top'));
        }));
        return _this;
    }
    XRPictureBoxSurface.prototype._createBackgroundPosition = function (alignment, sizing) {
