...
exports.ReportExplorerModel = void 0;
...
var ReportExplorerModel = (function (_super) {
    ...
    function ReportExplorerModel(reportModel, editableObject, clickHandler, dragDropHandler, selection) {
        ...
        _this._disposables.push(_this.itemsProvider = new analytics_internal_1.ObjectExplorerProvider([
            { model: reportModel, name: 'Report', displayName: analytics_utils_1.getLocalization('Report', 'ASPxReportsStringId.DocumentViewer_RibbonReportGroupText'), className: 'master_report', data: reportModel },
