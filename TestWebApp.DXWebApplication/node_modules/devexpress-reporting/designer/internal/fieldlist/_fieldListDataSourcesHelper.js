...
exports.FieldListDataSourcesHelper = exports.patchRequest = exports.maxNestingLevelUpdate = void 0;
...
function patchRequest(request, dataSources, state) {
    ...
    if (dataSource && dataSource.data) {
        if (dataSource.data instanceof dataFederation_1.DataFederationDataSource) {
            ...
            var serializableFederationDataSourceInfo = dataSource.data.getSerializableModel().getSerializableFederationDataSourceInfo();
            analytics_internal_1.extend(request, serializableFederationDataSourceInfo);
        }
        else
