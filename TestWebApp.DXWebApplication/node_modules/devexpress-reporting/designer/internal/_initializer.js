...
exports.createReportDesignerFromModel = exports.createReportDesigner = void 0;
...
function _createReportDesigner(element, data, callbacks, knownEnums, designerHandlerUri, previewHandlerUri, rtl, applyBindings) {
    ...
    return initializer
        ...
        var state = function () { return initializer.reportContext() && initializer.reportContext().state() || initializer.buildingModel.state; };
...
function createReportDesignerFromModel(model, element, callbacks, applyBindings) {
    ...
    if (model.availableCultures) {
        metadata_1.availableCultures(model.availableCultures.reduce(function (result, val) {
            var _a;
            return __assign(__assign({}, result), (_a = {}, _a[val.Name] = val.DisplayName, _a));
        }, {}));
    }
    ...
    if (!model.reportModel) {
        model.reportModel = subreportViewModel_1.SubreportViewModel.defaultReport;
    }
    else {
