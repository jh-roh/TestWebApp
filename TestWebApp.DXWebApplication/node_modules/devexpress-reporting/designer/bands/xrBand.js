...
exports.BandSurface = exports.BandViewModel = void 0;
...
var BandViewModel = (function (_super) {
    ...
    BandViewModel.prototype.createChildsArray = function (band, serializer) {
        ...
        if (band.SubBands) {
            Object.keys(band.SubBands).forEach(function (key) {
                subBands.push(_this.getControlFactory().createControl(__assign({ '@ControlType': 'SubBand' }, band.SubBands[key]), _this, serializer));
            });
        }
        if (subBands) {
    ...
    BandViewModel.prototype.addChild = function (control) {
        ...
        if (control.controlType === 'XRTableOfContents' && _headOrFooterBandType_1.isHeaderOrFooterBandType(this)) {
    ...
    BandViewModel.prototype.isPropertyDisabled = function (name) {
        if (name === 'dataMember' && this['dataSource']) {
            ...
            return !!this[bandsMetadata_1.repeatEveryPage.propertyName] && this[bandsMetadata_1.repeatEveryPage.propertyName]() ||
                !!this.parentModel().bands().filter(function (x) { return _controlTypes_1.isVerticalBand(x.controlType); }).length ||
...
var BandSurface = (function (_super) {
    ...
    function BandSurface(band, context, unitProperties) {
        ...
        _this.getUsefulRect = function () {
            ...
            usefulWidth -= _this._getGrayArea();
            if (_this.rtlLayout()) {
    ...
    BandSurface.prototype._getUnitPositionInParent = function () {
        ...
        var absoluteY = neighbors
            ...
            if (_controlTypes_1.isVerticalBand(currentBandModel.controlType) && isVerticalBandTakenIntoAccount)
                return sum;
            else if (_controlTypes_1.isVerticalBand(currentBandModel.controlType))
    ...
    BandSurface.prototype._getGrayArea = function () {
    ...
    BandSurface.prototype._initMultiColumn = function () {
        ...
        this._disposables.push(this.multiColumn = ko.computed(function () {
            ...
            var parentMultiColumn = _this.parent && !(_this.parent['_control'].controlType === 'DevExpress.XtraReports.UI.XtraReport') && _this.parent.parent.bandsHolder.multiColumn();
    ...
    Object.defineProperty(BandSurface.prototype, "parent", {
        get: function () {
