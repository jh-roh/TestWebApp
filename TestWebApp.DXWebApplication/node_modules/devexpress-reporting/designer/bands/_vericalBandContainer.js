...
var VerticalBandsContainerSurface = (function (_super) {
    ...
    function VerticalBandsContainerSurface(_parent) {
        ...
        _this._disposables.push(_this.bandPosition = ko.computed(function () {
            ...
            if (_this._parent && _this._parent._control.controlType === 'DetailReportBand') {
            ...
            write: function (newVal) { return _this.verticalBands().forEach((function (x) { return x._height(newVal - _verticalBandsUtils_1.markerHeight); })); }
            ...
            return Math.max.apply(Math, _this.verticalBands().map(function (x) { return (x.heightFromControls && x.heightFromControls()) || 1; })) + _verticalBandsUtils_1.markerHeight;
