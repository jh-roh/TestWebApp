...
exports.VerticalBandSurface = exports.VerticalBandViewModel = void 0;
...
var VerticalBandSurface = (function (_super) {
    ...
    function VerticalBandSurface(band, context, unitProperties) {
        ...
        _this.height = ko.pureComputed(function () {
            ...
            return _this._height() + _verticalBandsUtils_1.markerHeight;
        });
    ...
    VerticalBandSurface.prototype._getGrayArea = function () {
        return 0;
    };
    ...
    VerticalBandSurface.prototype.updateAbsolutePosition = function () {
        ...
        this.absolutePosition.y(this.verticalBandsContainer.topOffset() + _verticalBandsUtils_1.markerHeight);
    };
    ...
    Object.defineProperty(VerticalBandSurface.prototype, "parent", {
        get: function () {
