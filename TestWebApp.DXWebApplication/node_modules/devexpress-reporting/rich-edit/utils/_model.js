...
exports.RichEditFontModel = exports.RichEditPaddingModelWrapper = exports.RichLoader = exports.XRRichEditControlModel = void 0;
...
var _utils_1 = require("../../designer/internal/_utils");
...
var XRRichEditControlModel = (function (_super) {
    ...
    XRRichEditControlModel.prototype.saveDocument = function (documentFormat, onResultReady) {
        this._dispatcher.process({ documentConverted: onResultReady, queueAction: _utils_2.RichAction.SaveDocument, documentFormat: documentFormat, base64: undefined, ready: undefined, errorCallBack: undefined });
    };
    XRRichEditControlModel.prototype.newDocument = function (onResultReady) {
        this._dispatcher.process({ documentConverted: undefined, queueAction: _utils_2.RichAction.NewDocument, documentFormat: undefined, base64: undefined, ready: onResultReady, errorCallBack: undefined });
    };
    XRRichEditControlModel.prototype.openDocument = function (base64, documentFormat, onResultReady, onError) {
        this._dispatcher.process({ documentConverted: undefined, queueAction: _utils_2.RichAction.OpenDocument, documentFormat: documentFormat, base64: base64, ready: onResultReady, errorCallBack: onError });
    };
...
var RichEditPaddingModelWrapper = (function (_super) {
    ...
    RichEditPaddingModelWrapper.prototype._setPaddings = function () {
        ...
        ['left', 'right', 'top', 'bottom'].forEach(function (side) { return paddings[side] = _utils_1.recalculateUnit(_this._paddingModel[side]() || 0.01, _this._paddingModel.dpi()); });
