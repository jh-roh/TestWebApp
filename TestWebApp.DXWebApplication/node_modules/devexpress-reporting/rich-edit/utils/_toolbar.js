...
exports.ToolbarSurface = exports.ComponentCollection = exports.ComponentColorPicker = exports.ComponentFontSizeComboBox = exports.ComponentComboBox = exports.ComponentButton = exports.ComponentButtonGroup = exports.Component = exports.CustomComponent = void 0;
...
var ToolbarSurface = (function (_super) {
    ...
    function ToolbarSurface(options) {
        var _this = _super.call(this) || this;
        _this._popover = new analytics_widgets_internal_1.PopupComponentBase();
        ...
        _this.hideOnOutsideClick = function (e) {
            if (_this._popover.hideOnOutsideClick(e)) {
                _this.visible(false);
                return false;
            }
            return true;
