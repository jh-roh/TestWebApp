...
exports.chart = exports.chartSerializationsInfo = exports.ChartViewModel = void 0;
...
var _dataContainer_1 = require("./_dataContainer");
var _legend_1 = require("./_legend");
...
var ChartViewModel = (function (_super) {
    ...
    function ChartViewModel(model, serializer) {
        var _this = _super.call(this, analytics_internal_1.cutRefs(model), serializer, exports.chartSerializationsInfo) || this;
    ...
    ChartViewModel.toJson = function (value, serializer, refs) {
        return serializer.serialize(value, exports.chartSerializationsInfo, refs);
    };
...
exports.chartSerializationsInfo = [_chart_1.appearanceName, _chart_1.backImage, _chart_1.paletteName, _chart_1.sideBySideBarDistanceFixed, _chart_1.sideBySideEqualBarWidth, _chart_1.sideBySideBarDistance, _dataContainer_1.dataContainer, _diagram_2.diagram, _chart_1.titles, _legend_1.legend, _chart_1.legends, _chart_1.emptyChartText];
exports.chart = { propertyName: 'chart', modelName: 'Chart', displayName: 'Chart', from: ChartViewModel.from, toJsonObject: ChartViewModel.toJson, localizationId: 'DevExpress.XtraReports.UI.XRChart' };
