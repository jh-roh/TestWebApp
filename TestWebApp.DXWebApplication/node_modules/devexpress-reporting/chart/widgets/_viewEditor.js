    ...
    ViewEditor.prototype.generateViewItems = function () {
        ...
        if (!this.viewItems.length) {
            this.viewItems = this.values().map(function (x) {
                return __assign(__assign({}, x), { className: _this.generateViewClassName(x.value), templateName: _this.generateViewClassName(x.value, true) });
            });
        }
