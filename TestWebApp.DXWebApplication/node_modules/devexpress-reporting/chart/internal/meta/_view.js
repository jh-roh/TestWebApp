...
exports.viewMapper = exports.axisYName = exports.axisXName = exports.paneName = void 0;
...
var viewFillStyle = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.AreaSeriesViewBase.FillStyle', editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), from: _fillStyle_1.FillStyle.from(_fillStyle_1.fillStyleInfo, 'PolygonGradientFillOptions'), toJsonObject: _fillStyle_1.FillStyle.toJson };
...
var fillStyle1 = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.MarkerBase.FillStyle', editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), from: _fillStyle_1.FillStyle.from(_fillStyle_1.fillStyleInfo, 'PolygonGradientFillOptions'), toJsonObject: _fillStyle_1.FillStyle.toJson };
...
var fillStyle2 = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.RadarAreaSeriesView.FillStyle', editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), from: _fillStyle_1.FillStyle.from(_fillStyle_1.fillStyleInfo, 'PolygonGradientFillOptions'), toJsonObject: _fillStyle_1.FillStyle.toJson };
...
var fillStyle4 = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.BarSeriesView.FillStyle', editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), from: _fillStyle_1.FillStyle.from(_fillStyle_1.fillStyleInfo, 'RectangleGradientFillOptions'), toJsonObject: _fillStyle_1.FillStyle.toJson };
...
var fillStyle6 = { propertyName: 'fillStyle', modelName: 'FillStyle', displayName: 'Fill Style', localizationId: 'DevExpress.XtraCharts.FunnelSeriesView.FillStyle', editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), from: _fillStyle_1.FillStyle.from(_fillStyle_1.fillStyleInfo, 'PolygonGradientFillOptions'), toJsonObject: _fillStyle_1.FillStyle.toJson };
