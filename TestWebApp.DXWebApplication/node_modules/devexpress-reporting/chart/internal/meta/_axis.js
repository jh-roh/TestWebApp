...
exports.axisY3D = exports.axisX3D = exports.radarAxisY = exports.radarAxisX = exports.secondaryAxisXYSerializationsInfo = exports.axisXYSerializationsInfo = exports.constantLineSerializationsInfo = exports.axisLabelText = exports.showAxisLabel = exports.legendName = exports.showBehind = exports.axisValue = exports.axisValueSerializable = exports.scaleBreakSerializationsInfo = exports.gridLinesAxisY = exports.gridLinesAxisX = exports.qualitativeScaleOptions = exports.qualitativeScaleOptionsSerializationInfo = void 0;
...
exports.qualitativeScaleOptionsSerializationInfo = [autoGrid, gridOffset, gridSpacing], exports.qualitativeScaleOptions = { propertyName: 'qualitativeScaleOptions', modelName: 'QualitativeScaleOptions', displayName: 'Qualitative Scale Options', localizationId: 'DevExpress.XtraCharts.AxisX3D.QualitativeScaleOptions', info: exports.qualitativeScaleOptionsSerializationInfo, editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor') };
...
exports.gridLinesAxisX = { propertyName: 'gridLinesAxisX', modelName: 'GridLines', displayName: 'Grid Lines', info: gridLinesAxisBaseSerializationsInfo, editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.AxisBase.GridLines' }, exports.gridLinesAxisY = { propertyName: 'gridLinesAxisY', modelName: 'GridLines', displayName: 'Grid Lines', info: gridLinesAxisBaseSerializationsInfo, editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.AxisBase.GridLines' };
...
exports.axisValueSerializable = { propertyName: '_axisValue', modelName: '@AxisValueSerializable' }, exports.axisValue = { propertyName: 'axisValue', displayName: 'Axis Value', localizationId: 'DevExpress.XtraCharts.AxisCoordinate.AxisValue', editor: analytics_widgets_1.editorTemplates.getEditor('text') }, exports.showBehind = { propertyName: 'showBehind', modelName: '@ShowBehind', from: analytics_utils_1.parseBool, displayName: 'Show Behind', localizationId: 'DevExpress.XtraCharts.ConstantLine.ShowBehind', editor: analytics_widgets_1.editorTemplates.getEditor('bool') };
...
exports.showAxisLabel = { propertyName: 'showAxisLabel', modelName: '@ShowAxisLabel', displayName: 'Show Axis Label', localizationId: 'DevExpress.XtraCharts.Strip.ShowAxisLabel', editor: analytics_widgets_1.editorTemplates.getEditor('bool'), from: analytics_utils_1.parseBool }, exports.axisLabelText = { propertyName: 'axisLabelText', modelName: '@AxisLabelText', displayName: 'Axis Label Text', localizationId: 'DevExpress.XtraCharts.Strip.AxisLabelText', editor: analytics_widgets_1.editorTemplates.getEditor('text') };
...
exports.constantLineSerializationsInfo = [exports.axisValueSerializable, exports.axisValue, _common_1.name, _common_1.visible, _common_1.color, _common_1.showInLegend, exports.legendName, _common_1.legendText, exports.showBehind, _common_1.tag];
...
var radarAxisSerializationsInfo = [interlaced, interlacedColor, interlacedFillStyle, visualRange, minorCount], radarAxisXSerializationsInfo = [radarAxisXNumericScaleOptions, radarWholeRange, exports.gridLinesAxisX, radarAxisXLabel, exports.qualitativeScaleOptions].concat(radarAxisSerializationsInfo), radarAxisYSerializationsInfo = [_common_1.color, _common_1.thickness, _common_1.visible, radarAxisYNumericScaleOptions, topLevel, wholeRange, exports.gridLinesAxisY, radarAxisYLabel, tickmarks].concat(radarAxisSerializationsInfo);
...
exports.axisX3D = { propertyName: 'axisX', modelName: 'AxisX', displayName: 'Axis X', info: [exports.gridLinesAxisX, interlaced, exports.qualitativeScaleOptions].concat(axis3DSerializationsInfo), editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.GanttAxisX' };
exports.axisY3D = { propertyName: 'axisY', modelName: 'AxisY', displayName: 'Axis Y', info: [exports.gridLinesAxisY, axisY3DInterlaced].concat(axis3DSerializationsInfo), editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.SeparatePaneIndicator.AxisY' };
