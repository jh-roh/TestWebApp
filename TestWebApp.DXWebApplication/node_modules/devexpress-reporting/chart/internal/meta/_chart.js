...
exports.backImage = exports.paletteName = exports.appearanceName = exports.legends = exports.additionalLegendSerializationsInfo = exports.legendSerializationsInfo = exports.titles = exports.emptyChartText = exports.emptyChartTextSerializationsInfo = exports.seriesDataMember = exports.seriesSerializable = exports.dateTimeSumaryOptions = exports.numericSummaryOptions = exports.qualitativeSummaryOptions = exports.viewBindableSerializationInfo = exports.createViewsArray = exports.points = exports.colorDataMember = exports.dataFiltersConjunctionMode = exports.pivotGridDataSourceOptions = exports.autoLayoutSettingsEnabled = exports.autoBindingSettingsEnabled = exports.topNOptions = exports.topNOptionsSerializationsInfo = exports.lineMarker = exports.lineMarkerOptionsSerializationsInfo = exports.padding = exports.waterfallPositionValues = exports.funnelPositionValues = exports.piePositionValues = exports.barPositionValues = exports.stockSeriesPointsSortingKeys = exports.rangeSeriesPointsSortingKeys = exports.bubbleSeriesPointsSortingKeys = exports.commonSeriesPointsSortingKeys = exports.sideBySideBarDistance = exports.sideBySideBarDistanceFixed = exports.sideBySideEqualBarWidth = void 0;
...
exports.sideBySideEqualBarWidth = { propertyName: 'equalBarWidth', modelName: '@SideBySideEqualBarWidth', displayName: 'Side By Side Equal Bar Width', defaultVal: true, editor: analytics_widgets_1.editorTemplates.getEditor('bool'), from: analytics_utils_1.parseBool }, exports.sideBySideBarDistanceFixed = { propertyName: 'barDistanceFixed', modelName: '@SideBySideBarDistanceFixed', defaultVal: 1 }, exports.sideBySideBarDistance = { propertyName: 'barDistance', modelName: '@SideBySideBarDistance', defaultVal: 0.0 };
...
exports.lineMarkerOptionsSerializationsInfo = [_common_1.color, _series_1.colorEach, markerVisibility], exports.lineMarker = { propertyName: 'lineMarker', modelName: 'LineMarker', displayName: 'Line Marker', info: exports.lineMarkerOptionsSerializationsInfo, editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor') };
exports.topNOptionsSerializationsInfo = [enabled, mode, count, thresholdPercent, thresholdValue, showOthers, othersArgument], exports.topNOptions = { propertyName: 'topNOptions', modelName: 'TopNOptions', displayName: 'Top N Options', info: exports.topNOptionsSerializationsInfo, defaultVal: {}, editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor'), localizationId: 'DevExpress.XtraCharts.SeriesBase.TopNOptions' };
exports.autoBindingSettingsEnabled = { propertyName: 'autoBindingSettingsEnabled', modelName: '@AutoBindingSettingsEnabled', displayName: 'Auto Binding Settings Enabled', localizationId: 'DevExpress.XtraCharts.PivotGridDataSourceOptions.AutoBindingSettingsEnabled', defaultVal: true, editor: analytics_widgets_1.editorTemplates.getEditor('bool') }, exports.autoLayoutSettingsEnabled = { propertyName: 'autoLayoutSettingsEnabled', modelName: '@AutoLayoutSettingsEnabled', displayName: 'Auto Layout Settings Enabled', localizationId: 'DevExpress.XtraCharts.PivotGridDataSourceOptions.AutoLayoutSettingsEnabled', defaultVal: true, editor: analytics_widgets_1.editorTemplates.getEditor('bool') };
exports.pivotGridDataSourceOptions = { propertyName: 'pivotGridDataSourceOptions', modelName: 'PivotGridDataSourceOptions', displayName: 'Pivot Grid Data Source Options', localizationId: 'DevExpress.XtraReports.UI.XRChart.PivotGridDataSourceOptions', info: [exports.autoBindingSettingsEnabled, exports.autoLayoutSettingsEnabled], editor: analytics_widgets_1.editorTemplates.getEditor('objecteditor') };
exports.dataFiltersConjunctionMode = {
...
var createViewsArray = function (limitation) {
    var array = [];
...
exports.createViewsArray = createViewsArray;
...
exports.legendSerializationsInfo = [_common_1.textColor, _common_1.backColor, direction, alignmentVertical, alignmentHorizontal, _common_1.visibility, markerMode, markerOffset, _series_1.border, _common_1.margin, exports.padding, _common_1.font8];
