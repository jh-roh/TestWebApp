...
exports.SubDocumentApi = exports.SectionBreakTypeApi = exports.HeaderFooterTypeApi = exports.SubDocumentTypeApi = void 0;
...
var SubDocumentApi = (function () {
    ...
    SubDocumentApi.prototype.insertRtf = function (position, rtfText, callback) {
        ...
        if (!callback)
            callback = function () { };
        importer_1.insertRtfInSubDocumentPublic(this._processor, this._subDocument, position, rtfText, function (interval, isRtfValid) { return callback(common_1.isDefined(interval) ? interval_1.convertToIntervalApi(interval) : null, isRtfValid); });
    };
