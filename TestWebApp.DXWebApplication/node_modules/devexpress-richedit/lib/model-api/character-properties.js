...
exports.convertFromCharacterPropertiesApi = exports.convertToCharacterPropertiesApi = exports.CharacterPropertiesApi = exports.CharacterPropertiesScriptApi = void 0;
...
function convertFromCharacterPropertiesApi(properties, fontInfoCache, parameterIndex, setRestAsUndefined, propsCoreTemplate) {
    ...
    propsCoreTemplate.smallCaps = (_b = parameter_checker_1.ApiParametersChecker.check(properties.smallCaps, parameterIndex, true, [
        parameter_checker_1.ApiParametersChecker.booleanDescriptor('properties.smallCaps', function (val) { return val; })
    ])) !== null && _b !== void 0 ? _b : propsCoreTemplate.smallCaps;
    propsCoreTemplate.fontBold = (_c = parameter_checker_1.ApiParametersChecker.check(properties.bold, parameterIndex, true, [
    ...
    propsCoreTemplate.fontItalic = (_d = parameter_checker_1.ApiParametersChecker.check(properties.italic, parameterIndex, true, [
    ...
    propsCoreTemplate.fontInfo = (_e = parameter_checker_1.ApiParametersChecker.check(properties.fontName, parameterIndex, true, [
    ...
    propsCoreTemplate.fontSize = (_f = parameter_checker_1.ApiParametersChecker.check(properties.size, parameterIndex, true, [
    ...
    propsCoreTemplate.hidden = (_g = parameter_checker_1.ApiParametersChecker.check(properties.hidden, parameterIndex, true, [
    ...
    propsCoreTemplate.script = (_h = parameter_checker_1.ApiParametersChecker.check(properties.script, parameterIndex, true, [
    ...
    propsCoreTemplate.underlineWordsOnly = (_j = parameter_checker_1.ApiParametersChecker.check(properties.underlineWordsOnly, parameterIndex, true, [
