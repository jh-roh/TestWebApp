...
var full_screen_helper_1 = require("./ui/full-screen-helper");
var ClientRichEdit = (function () {
    function ClientRichEdit(element, options, publicRichEdit) {
        ...
        if (!this.internalApi)
            this.internalApi = {};
        var settings = settings_1.Settings.parse(options, function (id) { return publicRichEdit.document.subDocuments.getById(id); });
        ...
        this.fullScreenHelper = new full_screen_helper_1.FullScreenHelper(element);
    ...
    ClientRichEdit.prototype.createCore = function (settings) {
        ...
        this.core = new client_rich_edit_core_1.ClientRichEditCore(this, this.name, this.element, Math.random().toString(), settings.readOnly, this.barHolder, settings.unit, this.rulerSettings, options, settings.view, this.getStringResources());
    };
