export declare enum FileTabItemId {
...
export declare enum InsertTabItemId {
...
export declare enum PageLayoutTabItemId {
    MarginsMenu = 434,
    OrientationMenu = 435,
    SizeMenu = 436,
    ColumnsMenu = 437,
...
export declare enum ReferencesTabItemId {
    AddTextMenu = 439,
...
export declare enum MailMergeTabItemId {
    CreateFieldMenu = 442,
    CreateField = 178,
    CreateDateField = 203,
    CreateTimeField = 204,
...
export declare enum ViewTabItemId {
    SwitchToSimpleView = 405,
    SwitchToPrintLayout = 406,
    ToggleShowHorizontalRuler = 94,
    ToggleFullScreen = 98
}
export declare enum HeaderAndFooterTabItemId {
    GoToPageHeader = 227,
    GoToPageFooter = 228,
...
export declare enum TableDesignTabItemId {
...
export declare enum TableLayoutTabItemId {
    SelectMenu = 445,
    DeleteMenu = 446,
    InsertMenu = 447,
    AutoFitMenu = 448,
...
export declare enum FloatingObjectsFormatTabItemId {
    WrapTextMenu = 450,
    PositionMenu = 451,
...
//# sourceMappingURL=item-ids.d.ts.map