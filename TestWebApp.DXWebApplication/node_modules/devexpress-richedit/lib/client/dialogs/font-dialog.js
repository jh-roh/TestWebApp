...
var FontDialog = (function (_super) {
                    ...
                    items: [
                        {
                            ...
                            editorOptions: {
                                ...
                                text: localization_1.formatMessage('ASPxRichEditStringId.SmallCaps'),
                                onInitialized: function (e) { _this.smallCapsItem = e.component; },
                                onValueChanged: function (e) { _this.updateAllCaps(e.component.option('value')); }
                            }
                        },
                        {
                            dataField: 'allCaps',
                            ...
                            editorOptions: {
                                ...
                                onInitialized: function (e) { _this.allCapsItem = e.component; },
                                onValueChanged: function (e) { _this.updateSmallCaps(e.component.option('value')); }
                            }
                        },
                        {
                            dataField: 'hidden',
    ...
    FontDialog.prototype.updateAllCaps = function (smallCapsValue) {
        if (smallCapsValue)
            this.allCapsItem.option('value', false);
    };
    FontDialog.prototype.updateSmallCaps = function (allCapsValue) {
        if (allCapsValue)
