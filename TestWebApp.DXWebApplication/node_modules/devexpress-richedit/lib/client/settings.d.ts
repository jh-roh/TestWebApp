...
import { BookmarksSettings } from '../core/model/options/bookmarks';
...
export declare class Settings {
    ...
    static parse(settings: IRichEditSettings, subDocumentCreator: (id: number) => SubDocumentBaseApi): Settings;
