...
var PdfBoxExporter = (function () {
    ...
    PdfBoxExporter.prototype.export = function (row, box, boxIndex, rowOffset, baseLine, lastBoxIndexWhatCanStrikeoutAndUnderline) {
        ...
        if ((box instanceof layout_picture_box_1.LayoutPictureBox || box instanceof layout_anchored_picture_box_1.LayoutAnchoredPictureBox) && box.cacheInfo.isPdfCompatible()) {
            var base64 = box.cacheInfo.pdfCompatibleBase64;
