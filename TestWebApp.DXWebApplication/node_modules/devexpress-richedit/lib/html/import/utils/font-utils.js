...
exports.HtmlImporterFontUtils = void 0;
...
var HtmlImporterFontUtils = (function () {
    ...
    HtmlImporterFontUtils.getFontSizeCore = function (font) {
        ...
        if (font.indexOf("px") > 0)
            return unit_converter_1.UnitConverter.pixelsToPoints(parseInt(font));
...
exports.HtmlImporterFontUtils = HtmlImporterFontUtils;
