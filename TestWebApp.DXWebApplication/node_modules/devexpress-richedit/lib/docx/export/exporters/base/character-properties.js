...
exports.CharacterPropertiesExporter = void 0;
...
var CharacterPropertiesExporter = (function (_super) {
    ...
    CharacterPropertiesExporter.prototype.shouldExportRunProperties = function (run) {
        ...
        return props.getUseValue(enums_1.CharacterPropertiesMask.UseFontName) ||
            ...
            props.getUseValue(enums_1.CharacterPropertiesMask.UseSmallCaps) ||
    ...
    CharacterPropertiesExporter.prototype.smallCaps = function (props) {
        if (props.getUseValue(enums_1.CharacterPropertiesMask.UseSmallCaps))
    ...
    CharacterPropertiesExporter.prototype.backColor = function (props) {
        ...
        if (props.getUseValue(enums_1.CharacterPropertiesMask.UseShadingInfoIndex) &&
