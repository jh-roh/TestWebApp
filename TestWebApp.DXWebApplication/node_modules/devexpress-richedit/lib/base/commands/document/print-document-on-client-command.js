...
exports.PrintDocumentOnClient = void 0;
...
var PrintDocumentOnClient = (function (_super) {
    ...
    PrintDocumentOnClient.prototype.executeCore = function (_state, options) {
        ...
        this.control.commandManager.printTimerId = setTimeout(function () {
            ...
            if (_this.control.modelManager.richOptions.fields.updateFieldsBeforePrint) {
                update_field_command_base_1.UpdateFieldCommandBase.updateFields(_this, subDocsInfo, function () {
                    _this.printCore(htmlPrinting, printWindow, closePrintDialogWithHtmlPreview, needSwitchViewType, needToggleHiddenSymbols);
    ...
    PrintDocumentOnClient.prototype.printCore = function (htmlPrinting, printWindow, closePrintDialogWithHtmlPreview, needSwitchViewType, needToggleHiddenSymbols) {
        var _this = this;
        if (htmlPrinting)
            this.generatePrintDocument(printWindow, closePrintDialogWithHtmlPreview);
        else {
            pdf_1.pdfExport(this.control, function (blob, _stream) {
        ...
        if (needSwitchViewType)
            this.control.commandManager.getCommand(client_command_1.RichEditClientCommand.SwitchToSimpleView).execute(this.control.commandManager.isPublicApiCall);
    ...
    PrintDocumentOnClient.prototype.generatePrintDocument = function (printWindow, closePrintDialogWithHtmlPreview) {
        ...
        var interval = setInterval(function () {
            if (printWindow.document.readyState == 'complete') {
                printWindow.print();
                if (closePrintDialogWithHtmlPreview && !browser_1.Browser.AndroidMobilePlatform)
                    printWindow.close();
