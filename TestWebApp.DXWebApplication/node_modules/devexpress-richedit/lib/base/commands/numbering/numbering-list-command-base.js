...
exports.NumberingListCommandBase = exports.NumberingListCommandBaseBase = void 0;
...
var NumberingListCommandBase = (function (_super) {
    ...
    NumberingListCommandBase.prototype.executeCore = function (state, options) {
        ...
        if (state.value)
            ...
            var isMultilevelListType = this.getNumberingListType() == numbering_list_1.NumberingType.MultiLevel;
