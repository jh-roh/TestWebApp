        ...
        this.history.addTransaction(function () {
            for (var _i = 0, intervals_1 = intervals; _i < intervals_1.length; _i++) {
                ...
                if (subDocument.isEditable([removingInterval])) {
                    ...
                    _this.modelManipulator.range.removeInterval(new sub_document_1.SubDocumentInterval(subDocument, removingInterval), false, true, !_this.control.commandManager.isPublicApiCall);
                }
            }
        });
