...
exports.BackspaceCommand = void 0;
...
var BackspaceCommand = (function (_super) {
    ...
    BackspaceCommand.prototype.executeCore = function (_state, _options) {
        ...
        if (this.selection.activeSubDocument.isEditable([interval])) {
            ...
            this.modelManipulator.range.removeInterval(new sub_document_1.SubDocumentInterval(this.selection.activeSubDocument, interval), false, true, !this.control.commandManager.isPublicApiCall);
    ...
    BackspaceCommand.prototype.beforeExecute = function () {
        var _a;
    ...
    BackspaceCommand.prototype.afterExecute = function () {
        var _a;
