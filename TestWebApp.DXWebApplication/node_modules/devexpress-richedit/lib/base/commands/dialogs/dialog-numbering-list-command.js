...
exports.DialogNumberingListParameters = exports.DialogNumberingListCommand = void 0;
    ...
    DialogNumberingListCommand.prototype.applyParameters = function (_state, params) {
        ...
        if (params.selectedAbstractNumberingList) {
            if (this.selection.isCollapsed() && firstParagraph.isInList()) {
                ...
                var targetNumberingList = params.selectedAbstractNumberingList.getListType() == numbering_list_1.NumberingType.MultiLevel ? params.selectedAbstractNumberingList : abstractNumberingList;
