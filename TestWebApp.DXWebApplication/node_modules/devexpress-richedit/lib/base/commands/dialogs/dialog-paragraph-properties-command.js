...
exports.ParagraphDialogParameters = exports.DialogParagraphPropertiesCommand = void 0;
...
var DialogParagraphPropertiesCommand = (function (_super) {
    ...
    DialogParagraphPropertiesCommand.prototype.getLeftIndent = function (newParams, initParams) {
        if (newParams.leftIndent == null)
            return undefined;
        var leftIndent = this.getLeftIndentCore(newParams);
        return leftIndent !== initParams.leftIndent || newParams.firstLineIndentType !== initParams.firstLineIndentType ?
            leftIndent : undefined;
    };
    DialogParagraphPropertiesCommand.prototype.getLeftIndentCore = function (newParams) {
        if (newParams.firstLineIndentType === paragraph_properties_1.ParagraphFirstLineIndent.Hanging &&
            common_1.isDefined(newParams.leftIndent) && common_1.isDefined(newParams.firstLineIndent))
...
var ParagraphDialogParameters = (function (_super) {
    ...
    ParagraphDialogParameters.prototype.getLeftIndent = function (parProps) {
        if (parProps.firstLineIndentType === paragraph_properties_1.ParagraphFirstLineIndent.Hanging &&
            common_1.isDefined(parProps.leftIndent) && common_1.isDefined(parProps.firstLineIndent))
