...
exports.MergeTableCellsCommand = void 0;
...
var MergeTableCellsCommand = (function (_super) {
    ...
    MergeTableCellsCommand.prototype.getIntervalsForModifying = function () {
        if (this.control.isClientMode())
            return _super.prototype.getIntervalsForModifying.call(this);
        else {
            var table = this.selection.tableInfo.table;
            return [fixed_1.FixedInterval.fromPositions(table.getStartPosition(), table.getEndPosition())];
        }
    };
