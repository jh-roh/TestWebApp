...
var TableCommandBase = (function (_super) {
    tslib_1.__extends(TableCommandBase, _super);
    ...
    TableCommandBase.prototype.isEnabled = function () {
        ...
        return _super.prototype.isEnabled.call(this) && table != null &&
            this.control.selection.activeSubDocument.isEditable([fixed_1.FixedInterval.fromPositions(table.getStartPosition(), table.getEndPosition())]);
    };
