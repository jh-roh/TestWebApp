...
exports.ClearFormattingCommand = void 0;
        ...
        if (options.intervalsInfo.intervals.length > 0) {
            for (var i = 0, interval = void 0; interval = options.intervalsInfo.intervals[i]; i++) {
                if (interval.length > 0) {
                    ...
                    this.history.addAndRedo(new character_properties_history_items_1.FontSmallCapsHistoryItem(modelManipulator, new sub_document_1.SubDocumentInterval(subDocument, interval), defaultCharProperties.smallCaps, false));
