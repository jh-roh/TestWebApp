...
exports.SelectTableCellsRangeCommand = exports.ExtendSelectTableCommand = exports.SelectTableCommand = exports.ExtendSelectTableRowCommand = exports.SelectTableRowCommand = exports.SelectTableRowCommandOptions = exports.ExtendSelectTableColumnCommand = exports.SelectTableColumnCommand = exports.ExtendSelectTableCellCommand = exports.SelectTableCellCommand = exports.SelectTableCommandBase = void 0;
...
var SelectTableCommandBase = (function (_super) {
    ...
    SelectTableCommandBase.prototype.addSelection = function (firstPos, lastPos, isFirstSelection, visibleModelPosition) {
        ...
        if (isFirstSelection)
            ...
            this.selection.changeState(function (newState) {
                newState.addInterval(fixed_1.FixedInterval.fromPositions(Math.min(firstPos, lastPos), Math.max(firstPos, lastPos))).resetKeepX().setEndOfLine(false);
