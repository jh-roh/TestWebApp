...
exports.HitTestOfRectanglesResult = exports.HitTestManager = void 0;
...
var HitTestManager = (function () {
    ...
    HitTestManager.prototype.calcFloatingObject = function (considerBehindTextWrap) {
        ...
        for (var i = 0, obj = void 0; obj = anchoredObjects[i]; i++) {
            if (considerBehindTextWrap || obj.levelType != layout_anchored_object_box_1.AnchoredObjectLevelType.BehindText) {
