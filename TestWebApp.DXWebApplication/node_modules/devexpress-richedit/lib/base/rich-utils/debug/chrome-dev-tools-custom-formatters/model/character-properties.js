...
exports.CCF_CharacterProperties = void 0;
...
var CCF_CharacterProperties = (function (_super) {
    ...
    CCF_CharacterProperties.prototype.getFullDescription = function (_config) {
        ...
        if (useVal & enums_1.CharacterPropertiesMask.UseSmallCaps)
            list.push(new pair_1.Pair("smallCaps", this.curr.smallCaps));
    ...
    CCF_CharacterProperties.prototype.getUseVal = function () {
        return this.isMasked() ? this.curr.getUseValueFull() : enums_1.CharacterPropertiesMask.UseAll;
    };
