...
exports.CCF_DocumentLayout = void 0;
...
var CCF_DocumentLayout = (function (_super) {
    ...
    CCF_DocumentLayout.prototype.getList = function (placePagesInfo) {
        var list = [new pair_1.Pair("isFullyFormatted", this.curr.isFullyFormatted),
            ...
            new pair_1.Pair("lastMaxNumPages", this.curr.lastMaxNumPages), new pair_1.Pair("pagesColor", new elements_1.DivElement().setStyle("display: inline-block")
                .setText(color_1.ColorHelper.getCssString(this.curr.pageColor, false) + " (" + this.curr.pageColor + ") ")
                .setNode(base_formatter_1.BaseFormatter.getColorBoxNode(this.curr.pageColor))), new pair_1.Pair("anchorObjectsPositionInfo", this.curr.anchorObjectsPositionInfo)];
        if (placePagesInfo)
