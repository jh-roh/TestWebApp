...
exports.BoxRenderResult = exports.DocumentRendererPageCache = exports.DocumentRenderer = exports.SimpleViewCanvasSizeManager = void 0;
...
var DocumentRenderer = (function () {
    ...
    DocumentRenderer.prototype.renderBox = function (row, box, noNeedUnderlineAndStrikeout, level) {
        ...
        var height = math_1.MathUtils.round(box.height, 3);
        boxStyles.push("height: " + height + "px");
        if (browser_1.Browser.MacOSPlatform || browser_1.Browser.MacOSMobilePlatform)
        ...
        if (color_2.ColorUtils.getAlpha(backColor) > 0 && !noNeedUnderlineAndStrikeout) {
            var height_1 = row.height - row.getSpacingAfter();
            var bgBoxStyle = "top: 0px; left: " + Math.floor(box.x) + "px; width: " + Math.ceil(box.width) + "px; height: " + math_1.MathUtils.round(height_1, 3) +
    ...
    DocumentRenderer.setShapePropertiesToElement = function (element, shape, isTextBox) {
        element.style.backgroundColor = color_1.ColorHelper.getCssStringInternal(shape.fillColor);
