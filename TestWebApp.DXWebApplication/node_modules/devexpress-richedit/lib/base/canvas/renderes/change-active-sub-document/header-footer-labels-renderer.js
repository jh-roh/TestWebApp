...
exports.HeaderFooterLabelsRenderer = void 0;
    ...
    HeaderFooterLabelsRenderer.prototype.handlePageRender = function (pageIndex, force) {
        ...
        if (this.isHeaderFooterActive(layoutPage)) {
            if (!oldElems || force) {
                ...
                this.updateElementInfo(infoTexts.footerInfo, container, list_1.ListUtils.last(layoutPage.mainSubDocumentPageAreas), elements.footerInfoElement, HeaderFooterLabelsRenderer.getFooterInfoTopPosition);
            }
            else
                oldElems = null;
        }
