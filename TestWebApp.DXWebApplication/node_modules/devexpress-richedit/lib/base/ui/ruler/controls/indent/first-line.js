...
exports.RulerFirstLineIndentDragHandle = void 0;
...
var RulerFirstLineIndentDragHandle = (function (_super) {
    ...
    function RulerFirstLineIndentDragHandle(modelData, controls) {
        ...
        var template = template_manager_1.RulerTemplateManager.getFirstLineIndentElementTemplate();
        if (template)
            _this.rootElement.innerHTML = template;
