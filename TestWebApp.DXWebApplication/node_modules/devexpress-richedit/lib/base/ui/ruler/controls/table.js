...
exports.RulerTablesControl = exports.RulerTableColumnViewState = exports.RulerTableModelState = void 0;
...
var RulerTableColumnState = (function () {
    function RulerTableColumnState(modelData, controls) {
        ...
        var template = template_manager_1.RulerTemplateManager.getTableColumnDragElementTemplate();
        if (template)
