...
exports.RulerTabsControl = exports.RulerTabViewState = exports.RulerTabsControlState = void 0;
...
var RulerTabControl = (function () {
    ...
    RulerTabControl.prototype.applyTemplate = function () {
        var template = utils_1.RulerTabUtils.getTemplate(this.viewState.align);
        if (template)
