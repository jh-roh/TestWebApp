...
exports.RulerLeftIndentDragHandle = void 0;
...
var RulerLeftIndentDragHandle = (function (_super) {
    ...
    function RulerLeftIndentDragHandle(modelData, controls) {
        ...
        var topElementTemplate = template_manager_1.RulerTemplateManager.getLeftIndentTopElementTemplate();
        if (topElementTemplate)
            _this.topElement.innerHTML = topElementTemplate;
        var bodyElementTemplate = template_manager_1.RulerTemplateManager.getLeftIndentBodyElementTemplate();
        if (bodyElementTemplate)
            _this.bodyElement.innerHTML = bodyElementTemplate;
