...
exports.MouseHandlerHelper = exports.MouseHandlerDefaultState = void 0;
...
var MouseHandlerDefaultState = (function (_super) {
    ...
    MouseHandlerDefaultState.prototype.onMouseDoubleClick = function (evt) {
        ...
        if (this.isLeftArea(htr, evt) || htr.exactlyDetailLevel >= document_layout_details_level_1.DocumentLayoutDetailsLevel.PageArea) {
    ...
    MouseHandlerDefaultState.prototype.isLeftArea = function (htr, evt) {
        if (!htr)
            return false;
