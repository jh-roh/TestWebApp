...
exports.TouchHandlerBeginWaitForLongTapState = exports.TouchHandlerBeginTapProcessingState = exports.TouchHandlerWaitingStateBase = void 0;
...
var TouchHandlerWaitingStateBase = (function (_super) {
    ...
    TouchHandlerWaitingStateBase.prototype.shouldChangeSelection = function (_position) {
        return true;
    };
...
var TouchHandlerBeginWaitForLongTapState = (function (_super) {
    ...
    TouchHandlerBeginWaitForLongTapState.prototype.shouldChangeSelection = function (position) {
        return !list_1.ListUtils.anyOf(this.handler.control.selection.intervals, function (currVal, _index) {
