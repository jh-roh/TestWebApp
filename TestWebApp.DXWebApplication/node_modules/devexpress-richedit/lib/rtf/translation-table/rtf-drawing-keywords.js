...
exports.RtfDrawingKeywords = void 0;
var map_creator_1 = require("../../base-utils/map-creator");
var enums_1 = require("../../core/model/floating-objects/enums");
var RtfDrawingKeywords = (function () {
    function RtfDrawingKeywords() {
    }
    RtfDrawingKeywords.createDrawingObjectTextWrapTypeTable = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectTextWrapType.TopAndBottom, 1)
            .add(enums_1.AnchorObjectTextWrapType.Square, 2)
            .add(enums_1.AnchorObjectTextWrapType.None, 3)
            .add(enums_1.AnchorObjectTextWrapType.Tight, 4)
            .add(enums_1.AnchorObjectTextWrapType.Through, 5)
            .get();
    };
    RtfDrawingKeywords.createDrawingObjectTextWrapSideTable = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectTextWrapSide.Both, 0)
            .add(enums_1.AnchorObjectTextWrapSide.Left, 1)
            .add(enums_1.AnchorObjectTextWrapSide.Right, 2)
            .add(enums_1.AnchorObjectTextWrapSide.Largest, 3)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectHorizontalPositionAlignmentTable = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.None, 0)
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.Left, 1)
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.Center, 2)
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.Right, 3)
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.Inside, 4)
            .add(enums_1.AnchorObjectHorizontalPositionAlignment.Outside, 5)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectHorizontalPositionTypeTable = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectHorizontalPositionType.Margin, 0)
            .add(enums_1.AnchorObjectHorizontalPositionType.Page, 1)
            .add(enums_1.AnchorObjectHorizontalPositionType.Column, 2)
            .add(enums_1.AnchorObjectHorizontalPositionType.Character, 3)
            .add(enums_1.AnchorObjectHorizontalPositionType.LeftMargin, 4)
            .add(enums_1.AnchorObjectHorizontalPositionType.RightMargin, 5)
            .add(enums_1.AnchorObjectHorizontalPositionType.InsideMargin, 6)
            .add(enums_1.AnchorObjectHorizontalPositionType.OutsideMargin, 7)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectVerticalPositionAlignment = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectVerticalPositionAlignment.None, 0)
            .add(enums_1.AnchorObjectVerticalPositionAlignment.Top, 1)
            .add(enums_1.AnchorObjectVerticalPositionAlignment.Center, 2)
            .add(enums_1.AnchorObjectVerticalPositionAlignment.Bottom, 3)
            .add(enums_1.AnchorObjectVerticalPositionAlignment.Inside, 4)
            .add(enums_1.AnchorObjectVerticalPositionAlignment.Outside, 5)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectVerticalPositionType = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.AnchorObjectVerticalPositionType.Margin, 0)
            .add(enums_1.AnchorObjectVerticalPositionType.Page, 1)
            .add(enums_1.AnchorObjectVerticalPositionType.Paragraph, 2)
            .add(enums_1.AnchorObjectVerticalPositionType.Line, 3)
            .add(enums_1.AnchorObjectVerticalPositionType.TopMargin, 4)
            .add(enums_1.AnchorObjectVerticalPositionType.BottomMargin, 5)
            .add(enums_1.AnchorObjectVerticalPositionType.InsideMargin, 6)
            .add(enums_1.AnchorObjectVerticalPositionType.OutsideMargin, 7)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectRelativeWidthType = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.RelativeWidthType.Margin, 0)
            .add(enums_1.RelativeWidthType.Page, 1)
            .add(enums_1.RelativeWidthType.LeftMargin, 2)
            .add(enums_1.RelativeWidthType.RightMargin, 3)
            .add(enums_1.RelativeWidthType.InsideMargin, 4)
            .add(enums_1.RelativeWidthType.OutsideMargin, 5)
            .get();
    };
    RtfDrawingKeywords.createFloatingObjectRelativeHeightType = function () {
        return new map_creator_1.MapCreator()
            .add(enums_1.RelativeHeightType.Margin, 0)
            .add(enums_1.RelativeHeightType.Page, 1)
            .add(enums_1.RelativeHeightType.TopMargin, 2)
            .add(enums_1.RelativeHeightType.BottomMargin, 3)
            .add(enums_1.RelativeHeightType.InsideMargin, 4)
            .add(enums_1.RelativeHeightType.OutsideMargin, 5)
            .get();
    };
    ...
    return RtfDrawingKeywords;
}());
exports.RtfDrawingKeywords = RtfDrawingKeywords;
