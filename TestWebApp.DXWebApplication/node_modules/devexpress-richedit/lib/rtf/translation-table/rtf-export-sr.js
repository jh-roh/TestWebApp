...
var RtfExportSR = (function () {
    function RtfExportSR() {
    }
...
exports.RtfExportSR = RtfExportSR;
function createShadingPatternTable() {
    return new map_creator_1.MapCreator()
        .add(shading_pattern_1.ShadingPattern.ThinHorzStripe, "\\bghoriz")
        .add(shading_pattern_1.ShadingPattern.ThinVertStripe, "\\bgvert")
        .add(shading_pattern_1.ShadingPattern.ThinReverseDiagStripe, "\\bgfdiag")
        .add(shading_pattern_1.ShadingPattern.ThinDiagStripe, "\\bgbdiag")
        .add(shading_pattern_1.ShadingPattern.ThinHorzCross, "\\bgcross")
        .add(shading_pattern_1.ShadingPattern.ThinDiagCross, "\\bgdcross")
        .add(shading_pattern_1.ShadingPattern.HorzStripe, "\\bgdkhoriz")
        .add(shading_pattern_1.ShadingPattern.VertStripe, "\\bgdkvert")
        .add(shading_pattern_1.ShadingPattern.ReverseDiagStripe, "\\bgdkfdiag")
        .add(shading_pattern_1.ShadingPattern.DiagStripe, "\\bgdkbdiag")
        .add(shading_pattern_1.ShadingPattern.HorzCross, "\\bgdkcross")
        .add(shading_pattern_1.ShadingPattern.DiagCross, "\\bgdkdcross")
        .get();
}
function createRunShadingPatternTable() {
    return new map_creator_1.MapCreator()
        .add(shading_pattern_1.ShadingPattern.ThinHorzStripe, "\\chbghoriz")
        .add(shading_pattern_1.ShadingPattern.ThinVertStripe, "\\chbgvert")
        .add(shading_pattern_1.ShadingPattern.ThinReverseDiagStripe, "\\chbgfdiag")
        .add(shading_pattern_1.ShadingPattern.ThinDiagStripe, "\\chbgbdiag")
        .add(shading_pattern_1.ShadingPattern.ThinHorzCross, "\\chbgcross")
        .add(shading_pattern_1.ShadingPattern.ThinDiagCross, "\\chbgdcross")
        .add(shading_pattern_1.ShadingPattern.HorzStripe, "\\chbgdkhoriz")
        .add(shading_pattern_1.ShadingPattern.VertStripe, "\\chbgdkvert")
        .add(shading_pattern_1.ShadingPattern.ReverseDiagStripe, "\\chbgdkfdiag")
        .add(shading_pattern_1.ShadingPattern.DiagStripe, "\\chbgdkbdiag")
        .add(shading_pattern_1.ShadingPattern.HorzCross, "\\chbgdkcross")
        .add(shading_pattern_1.ShadingPattern.DiagCross, "\\chbgdkdcross")
        .get();
}
function createTableCellShadingPatternTable() {
    return new map_creator_1.MapCreator()
        .add(shading_pattern_1.ShadingPattern.ThinHorzStripe, "\\clbghoriz")
        .add(shading_pattern_1.ShadingPattern.ThinVertStripe, "\\clbgvert")
        .add(shading_pattern_1.ShadingPattern.ThinReverseDiagStripe, "\\clbgfdiag")
        .add(shading_pattern_1.ShadingPattern.ThinDiagStripe, "\\clbgbdiag")
        .add(shading_pattern_1.ShadingPattern.ThinHorzCross, "\\clbgcross")
        .add(shading_pattern_1.ShadingPattern.ThinDiagCross, "\\clbgdcross")
        .add(shading_pattern_1.ShadingPattern.HorzStripe, "\\clbgdkhor")
        .add(shading_pattern_1.ShadingPattern.VertStripe, "\\clbgdkvert")
        .add(shading_pattern_1.ShadingPattern.ReverseDiagStripe, "\\clbgdkfdiag")
        .add(shading_pattern_1.ShadingPattern.DiagStripe, "\\clbgdkbdiag")
        .add(shading_pattern_1.ShadingPattern.HorzCross, "\\clbgdkcross")
        .add(shading_pattern_1.ShadingPattern.DiagCross, "\\clbgdkdcross")
        .get();
}
function createTableStyleShadingPatternTable() {
    return new map_creator_1.MapCreator()
        .add(shading_pattern_1.ShadingPattern.ThinHorzStripe, "\\tsbghoriz")
        .add(shading_pattern_1.ShadingPattern.ThinVertStripe, "\\tsbgvert")
        .add(shading_pattern_1.ShadingPattern.ThinReverseDiagStripe, "\\tsbgfdiag")
        .add(shading_pattern_1.ShadingPattern.ThinDiagStripe, "\\tsbgbdiag")
        .add(shading_pattern_1.ShadingPattern.ThinHorzCross, "\\tsbgcross")
        .add(shading_pattern_1.ShadingPattern.ThinDiagCross, "\\tsbgdcross")
        .add(shading_pattern_1.ShadingPattern.HorzStripe, "\\tsbgdkhor")
        .add(shading_pattern_1.ShadingPattern.VertStripe, "\\tsbgdkvert")
        .add(shading_pattern_1.ShadingPattern.ReverseDiagStripe, "\\tsbgdkfdiag")
        .add(shading_pattern_1.ShadingPattern.DiagStripe, "\\tsbgdkbdiag")
        .add(shading_pattern_1.ShadingPattern.HorzCross, "\\tsbgdkcross")
        .add(shading_pattern_1.ShadingPattern.DiagCross, "\\tsbgdkdcross")
        .get();
}
function createThemeColorValuesTable() {
    return new map_creator_1.MapCreator()
        .add(enums_1.ThemeColorValues.Dark1, "\\cmaindarkone")
        .add(enums_1.ThemeColorValues.Light1, "\\cmainlightone")
        .add(enums_1.ThemeColorValues.Dark2, "\\cmaindarktwo")
        .add(enums_1.ThemeColorValues.Light2, "\\cmainlighttwo")
        .add(enums_1.ThemeColorValues.Accent1, "\\caccentone")
        .add(enums_1.ThemeColorValues.Accent2, "\\caccenttwo")
        .add(enums_1.ThemeColorValues.Accent3, "\\caccentthree")
        .add(enums_1.ThemeColorValues.Accent4, "\\caccentfour")
        .add(enums_1.ThemeColorValues.Accent5, "\\caccentfive")
        .add(enums_1.ThemeColorValues.Accent6, "\\caccentsix")
        .add(enums_1.ThemeColorValues.Hyperlink, "\\chyperlink")
        .add(enums_1.ThemeColorValues.FollowedHyperlink, "\\cfollowedhyperlink")
        .add(enums_1.ThemeColorValues.Background1, "\\cbackgroundone")
        .add(enums_1.ThemeColorValues.Text1, "\\ctextone")
        .add(enums_1.ThemeColorValues.Background2, "\\cbackgroundtwo")
        .add(enums_1.ThemeColorValues.Text2, "\\ctexttwo")
        .get();
}
