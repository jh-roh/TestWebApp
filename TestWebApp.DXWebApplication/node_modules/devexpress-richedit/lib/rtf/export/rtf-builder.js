...
exports.toUTF8Array = exports.CreateByteToHexString = exports.AddHexToMarkTable = exports.CreateSpecialPCDataMarksTable = exports.CreateSpecialMarksTable = exports.RtfBuilder = void 0;
...
var RtfBuilder = (function () {
    ...
    RtfBuilder.prototype.containsNonAnsiChar = function (str) {
        var _this = this;
        return list_1.ListUtils.anyOf(str.split(''), function (ch) { return !_this.isANSI(_this.getCode(ch)); });
    };
    ...
    RtfBuilder.prototype.writeDescription = function (nonVisualDrawingObjectInfo) {
        var result = '';
        if (!string_1.StringUtils.isNullOrEmpty(nonVisualDrawingObjectInfo.title)) {
            result += "Title: " + nonVisualDrawingObjectInfo.title;
            if (!string_1.StringUtils.isNullOrEmpty(nonVisualDrawingObjectInfo.description))
                result += " - Description: " + nonVisualDrawingObjectInfo.description;
        }
        else if (!string_1.StringUtils.isNullOrEmpty(nonVisualDrawingObjectInfo.description))
            result = nonVisualDrawingObjectInfo.description;
        if (!string_1.StringUtils.isNullOrEmpty(result))
