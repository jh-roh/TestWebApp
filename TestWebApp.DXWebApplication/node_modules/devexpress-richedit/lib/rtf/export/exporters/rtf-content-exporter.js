...
exports.RtfContentExporter = void 0;
...
var RtfContentExporter = (function () {
    ...
    RtfContentExporter.prototype.exportSubDocument = function (subDocument, pieceTableExporter) {
        ...
        var originalPermissionsIterator = this.permissionsIterator;
        var originalBookmarksIterator = this.bookmarksIterator;
        ...
        this.pieceTableNumberingListCounters = originalPieceTableNumberingListCounters ? originalPieceTableNumberingListCounters : new piece_table_numbering_list_counters_manager_1.PieceTableNumberingListCountersManager();
    ...
    RtfContentExporter.prototype.createPermissionsIterator = function () {
        var permissionsIterator = new cross_existing_iterator_1.CrossExistingIterator(this.subDocument.rangePermissions);
        permissionsIterator.init();
        return permissionsIterator;
    };
    RtfContentExporter.prototype.createBookmarkIterator = function () {
        var bookmarksIterator = new cross_existing_iterator_1.CrossExistingIterator(this.subDocument.bookmarks);
    ...
    RtfContentExporter.prototype.exportTextRun = function (run, runText, absolutePosition) {
        var _this = this;
        this.rtfBuilder.openGroup();
        ...
        if (this.bookmarksIterator.hasObjects(absolutePosition, runLength) || this.permissionsIterator.hasObjects(absolutePosition, runLength)) {
            var startIndex_1 = 0;
            var length_1 = 1;
            var exportRunText = function () {
                _this.rtfBuilder.writeText(runText.substr(startIndex_1, length_1));
                startIndex_1 += length_1;
                length_1 = 0;
            };
            while (startIndex_1 + length_1 < runText.length) {
                var position = absolutePosition + startIndex_1 + length_1;
            ...
            if (length_1 > 0)
                this.rtfBuilder.writeText(runText.substr(startIndex_1, length_1));
        }
        else
    ...
    RtfContentExporter.prototype.intToShortString = function (value) {
        ...
        var high = value >> 8;
        return string_1.StringUtils.padLeft(low.toString(16), 2, '0') + string_1.StringUtils.padLeft(high.toString(16), 2, '0');
    };
...
function createPredefinedUserGroups() {
    return new map_creator_1.MapCreator()
        .add(0xFFFA, range_permissions_1.RangePermission.Current_GROUP_NAME)
        .add(0xFFFB, range_permissions_1.RangePermission.Editors_GROUP_NAME)
        .add(0xFFFC, range_permissions_1.RangePermission.Owners_GROUP_NAME)
        .add(0xFFFD, range_permissions_1.RangePermission.Contributors_GROUP_NAME)
        .add(0xFFFE, range_permissions_1.RangePermission.Administrators_GROUP_NAME)
        .add(0xFFFF, range_permissions_1.RangePermission.Everyone_GROUP_NAME)
        .get();
}
