...
exports.RtfAnchoredRunExporter = void 0;
...
var RtfAnchoredRunExporter = (function () {
    function RtfAnchoredRunExporter(rtfBuilder, anchorInfo, shape, size, nonVisualDrawingObjectInfo) {
    ...
    RtfAnchoredRunExporter.prototype.export = function () {
        ...
        if (!string_1.StringUtils.isNullOrEmpty(this.nonVisualDrawingObjectInfo.name))
            this.rtfBuilder.writeShapeProperty(rtf_drawing_keywords_1.RtfDrawingKeywords.Name, this.nonVisualDrawingObjectInfo.name);
