...
exports.DecoderHelper = void 0;
var code_pages_1 = require("../encoding/code-pages");
var hangul949_decoder_helper_1 = require("./hangul949-decoder-helper");
var decoder_base_1 = require("./decoder-base");
var gb2315_decoder_helper_1 = require("./gb2315-decoder-helper");
...
var DecoderHelper = (function () {
    ...
    DecoderHelper.decode = function (str, codePage) {
        ...
        else if (codePage == code_pages_1.CodePages.Vietnamese)
            return decoder_base_1.DecoderBase.decode(str, specified_symbols_1.windows1258specifiedSymbols);
        return str;
    };
    DecoderHelper.getChars = function (bytes, codePage) {
        if (codePage == code_pages_1.CodePages.GB2315)
            return gb2315_decoder_helper_1.GB2315DecoderHelper.getChars(bytes);
        else if (codePage == code_pages_1.CodePages.Hangul)
            return hangul949_decoder_helper_1.HangulDecoderHelper.getChars(bytes);
        return bytes;
    };
