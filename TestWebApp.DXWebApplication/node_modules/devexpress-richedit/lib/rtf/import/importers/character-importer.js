...
exports.RtfCharacterImporter = void 0;
...
var RtfCharacterImporter = (function (_super) {
    ...
    RtfCharacterImporter.prototype.setFontNameAndInsertText = function (text, charType) {
        unicode_char_helper_1.UnicodeCharHelper.setUnicodeFontNameByCharType(this.data.documentModel.cache.fontInfoCache, charType, this.characterFormatting);
    ...
    RtfCharacterImporter.prototype.addSimpleRun = function (runConstr, text, useLastProperties) {
        ...
        var run = new runConstr(this.logPosition, this.data.importers.paragraph.paragraph, properties);
    ...
    RtfCharacterImporter.prototype.splitByCharTypeAndInsertText = function (text) {
        if (!text)
            return;
        var oldFontInfo = this.characterFormatting.coreProperties.fontInfo;
        var currentText = text.charAt(0);
        var lastCharType = unicode_char_helper_1.UnicodeCharHelper.calculateCharType(currentText);
        for (var i = 1; i < text.length; i++) {
            var ch = text.charAt(i);
            var charType = unicode_char_helper_1.UnicodeCharHelper.calculateCharType(ch);
