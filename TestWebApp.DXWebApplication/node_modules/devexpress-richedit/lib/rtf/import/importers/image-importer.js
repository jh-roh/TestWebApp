...
exports.RtfImageImporter = void 0;
...
var RtfImageImporter = (function (_super) {
    ...
    RtfImageImporter.prototype.isShapeFieldContent = function () {
        return this.data.importers.field.currentField && this.data.importers.field.currentField.isShapeField;
    };
    RtfImageImporter.prototype.isInlineTextBox = function () {
        return this.isShapeFieldContent() && list_1.ListUtils.last(this.data.subDocument.chunks[0].textRuns) instanceof anchored_text_box_run_1.AnchoredTextBoxRun;
    };
