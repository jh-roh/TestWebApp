...
exports.DefaultDestination = void 0;
...
var DefaultDestination = (function (_super) {
    ...
    DefaultDestination.onNoUICompat = function (importer, _parameterValue, _hasParameter) {
        importer.documentModel.compatibilitySettings.compatibilityMode = document_model_1.CompatibilityMode.Word2007;
    ...
    DefaultDestination.onSectionBreakNone = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.currentProperties.coreProperties.startType = enums_1.SectionStartType.Continuous;
    };
    DefaultDestination.onSectionBreakColumn = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.currentProperties.coreProperties.startType = enums_1.SectionStartType.Column;
    };
    DefaultDestination.onSectionBreakPage = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.currentProperties.coreProperties.startType = enums_1.SectionStartType.NextPage;
    };
    DefaultDestination.onSectionBreakEvenPage = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.currentProperties.coreProperties.startType = enums_1.SectionStartType.EvenPage;
    };
    DefaultDestination.onSectionBreakOddPage = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.currentProperties.coreProperties.startType = enums_1.SectionStartType.OddPage;
    };
    ...
    DefaultDestination.onHeaderKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(true, enums_1.HeaderFooterType.Odd);
    };
    DefaultDestination.onHeaderForLeftPagesKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(true, enums_1.HeaderFooterType.Even);
    };
    ...
    DefaultDestination.onHeaderForFirstPageKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(true, enums_1.HeaderFooterType.First);
    };
    DefaultDestination.onFooterKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(false, enums_1.HeaderFooterType.Odd);
    };
    DefaultDestination.onFooterForLeftPagesKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(false, enums_1.HeaderFooterType.Even);
    };
    ...
    DefaultDestination.onFooterForFirstPageKeyword = function (importer, _parameterValue, _hasParameter) {
        importer.importers.section.insertHeaderFooter(false, enums_1.HeaderFooterType.First);
    };
