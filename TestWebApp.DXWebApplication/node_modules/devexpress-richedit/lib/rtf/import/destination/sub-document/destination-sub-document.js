...
exports.DestinationSubDocument = void 0;
...
var DestinationSubDocument = (function (_super) {
    ...
    DestinationSubDocument.onSmallCapsKeyword = function (importer, parameterValue, hasParameter) {
        var val = hasParameter ? parameterValue != 0 : true;
        importer.importers.character.characterFormatting.coreProperties.setValue(character_property_descriptor_1.CharacterPropertyDescriptor.smallCaps, val);
    };
