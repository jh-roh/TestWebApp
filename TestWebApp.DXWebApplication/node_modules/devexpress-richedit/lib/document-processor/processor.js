...
exports.DocumentProcessorBase = void 0;
...
var DocumentProcessorBase = (function () {
    ...
    DocumentProcessorBase.prototype.openDocumentInner = function (file, format, callback) {
        ...
        this.activeDocumentImporter.importFromFile(file, this.modelManager.richOptions, function (model, formatImagesImporter) {
            _this.activeDocumentImporter = null;
            _this.createModel(model);
            _this.importImages(formatImagesImporter);
            callback(true);
        }, function (_reason) {
            _this.activeDocumentImporter = null;
            callback(false);
    ...
    DocumentProcessorBase.prototype.importImages = function (formatImagesImporter) {
