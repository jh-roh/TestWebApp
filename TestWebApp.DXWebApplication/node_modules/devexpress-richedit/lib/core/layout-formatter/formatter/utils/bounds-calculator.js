...
var BoundsCalculator = (function () {
    ...
    BoundsCalculator.prototype.setFooterBounds = function (currHeight) {
        ...
        if (currHeight == -1) {
            ...
            var pageAreaHeight = this.footerOffset + currHeight;
            this.footerPageAreaBounds = new rectangle_1.Rectangle(this.marginLeft, this.pageHeight - pageAreaHeight, this.availableHeaderFooterWidth, pageAreaHeight);
            this.footerColumnBounds = new rectangle_1.Rectangle(0, 0, this.footerPageAreaBounds.width, currHeight);
        }
    };
