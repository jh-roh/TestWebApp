...
var BaseFormatter = (function () {
    ...
    BaseFormatter.prototype.createRow = function () {
        var rowSpacingBeforeApplier = this.tableFormatter ?
            ...
            new row_spacing_before_applier_1.RowSpacingBeforeApplier(this.subDocument.documentModel.compatibilitySettings, this.lastRowInfo, this.subDocument.paragraphs, this.layoutPosition.rowIndex == 0);
    ...
    BaseFormatter.prototype.cantPlaceRowOnThisColumn = function (row, startRowPosition) {
        var lineBottom = row.y + row.lineHeight;
