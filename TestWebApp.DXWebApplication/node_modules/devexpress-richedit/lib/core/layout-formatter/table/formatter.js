...
exports.Formatter = exports.AddRowToTableResult = void 0;
...
var Formatter = (function () {
    ...
    Object.defineProperty(Formatter.prototype, "posToWaitingContinuedFormatterMap", {
        get: function () {
    ...
    Formatter.prototype.getNestedTablePosition = function (tablePositions) {
    ...
    Formatter.prototype.createInnerFormatter = function (tablePositions) {
        ...
        var index = this.nestedLevel + 1;
        var tblPos = this.getNestedTablePosition(tablePositions);
        if (tblPos && (tblPos.rowIndex != 0 || tblPos.cellIndex != 0)) {
            var formatter = this.posToWaitingContinuedFormatterMap[tblPos.cell.endParagrapPosition.value];
            if (formatter) {
    ...
    Formatter.prototype.isCellFinished = function (tblPoss) {
    ...
    Formatter.prototype.processResultOfTopLevelFormatter = function (result, info) {
        ...
        if (result.anyOf(AddRowToTableResult.TableFinished, AddRowToTableResult.GoToNextColumn)) {
            ...
            if (result.get(AddRowToTableResult.TableFinished))
                ...
                var actualNestedTablePos = this.getNestedTablePosition(this.tableInfo.rowFormatter.iterator.getWrap(false).info.tablePosition);
                if (!actualNestedTablePos) {
                    var oldNestedTablePos = this.getNestedTablePosition(info.tablePosition);
    ...
    Formatter.prototype.setRowHeight = function () {
        ...
        var rowInfo = this.tableInfo.rows[rowIndex];
        var height = rowInfo.heightInfo;
