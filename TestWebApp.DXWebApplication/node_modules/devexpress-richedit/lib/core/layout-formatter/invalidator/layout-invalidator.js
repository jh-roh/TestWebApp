...
exports.LayoutInvalidator = void 0;
...
var LayoutInvalidator = (function () {
    ...
    LayoutInvalidator.prototype.getStartModelPositionOfRow = function (lp) {
        ...
        if (prevLP.advanceToPrevRow(this.layout)) {
            ...
            var curLPTblCellInfo = (_a = lp.row) === null || _a === void 0 ? void 0 : _a.tableCellInfo;
    ...
    LayoutInvalidator.isLayoutRowRowStartWithMultipageTable = function (layoutRow) {
        ...
        return tableCellInfo && (tableCellInfo.parentRow.rowIndex != 0 || tableCellInfo.parentRow.parentTable.getTopLevelColumn().isBoundWithPrev());
    };
