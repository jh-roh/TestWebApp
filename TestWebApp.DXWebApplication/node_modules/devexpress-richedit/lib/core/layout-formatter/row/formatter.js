...
exports.RowFormatter = exports.TextRowFormatterState = void 0;
...
var RowFormatter = (function () {
    function RowFormatter(formatterManager, subDocumentId) {
        ...
        RowFormatter.addBoxFunctionMap[layout_box_1.LayoutBoxType.Dash] = function () { this.currentState.addDashBox(); };
