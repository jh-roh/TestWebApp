...
exports.InputPositionCharacterProperties = exports.InputPositionBase = void 0;
...
var InputPositionBase = (function () {
    ...
    Object.defineProperty(InputPositionBase.prototype, "parPropsBundle", {
        get: function () {
            return new properties_bundle_1.MaskedParagraphPropertiesBundle(this.getMaskedParagraphProperties().clone(), this.getParagraphStyle());
        },
        enumerable: false,
        configurable: true
    });
    ...
    InputPositionBase.prototype.getParagraphStyle = function () {
    ...
    InputPositionBase.prototype.getMaskedParagraphProperties = function () {
    ...
    InputPositionBase.prototype.applyAllCharacterProperties = function (props, onlyOnInputPosition) {
        if (onlyOnInputPosition === void 0) { onlyOnInputPosition = false; }
    ...
    InputPositionBase.prototype.applyAllCharacterPropertiesToSourceRun = function () {
        this.setSourceRun();
