...
exports.TextBoxProperties = void 0;
...
var TextBoxProperties = (function () {
    function TextBoxProperties(contentMargins) {
        ...
        this.upright = false;
        this.verticalAlignment = enums_1.DrawingTextAnchoringType.Top;
        this.wrapText = true;
        this.leftMargin = 0;
        this.rightMargin = 0;
        this.topMargin = 0;
    ...
    TextBoxProperties.prototype.getContentMargins = function () {
        return new margins_1.Margins(this.leftMargin, this.rightMargin, this.topMargin, this.bottomMargin);
    };
