...
exports.DocumentVariables = exports.CompatibilitySettings = exports.CompatibilityMode = exports.ResetFormattingCacheType = exports.SearchSettings = exports.DocumentModel = void 0;
...
var DocumentModel = (function () {
    function DocumentModel(modelOptions, subDocumentsIdCounter) {
        ...
        this.mainSubDocument = this.importSubDocument(sub_document_infos_1.SubDocumentInfoBase.create(enums_2.SubDocumentInfoType.Main, sub_document_1.SubDocument.MAIN_SUBDOCUMENT_ID, -1));
    ...
    DocumentModel.prototype.getAllImages = function () {
        var result = [];
        number_1.NumberMapUtils.forEach(this.subDocuments, function (subDoc) {
            number_1.NumberMapUtils.forEach(subDoc.chunks, function (chunk) {
                number_1.NumberMapUtils.forEach(chunk.textRuns, function (run) {
                    if (run instanceof anchored_picture_run_1.AnchoredPictureRun || run instanceof inline_picture_run_1.InlinePictureRun)
    ...
    DocumentModel.prototype.getActualPageBackgroundColor = function () {
        if (!this.displayBackgroundShape)
            return color_1.ColorHelper.NO_COLOR;
...
})(CompatibilityMode = exports.CompatibilityMode || (exports.CompatibilityMode = {}));
var CompatibilitySettings = (function () {
    ...
    Object.defineProperty(CompatibilitySettings.prototype, "allowParagraphSpacingAfterPageBreak", {
        get: function () {
    ...
    Object.defineProperty(CompatibilitySettings.prototype, "layoutInTableCell", {
        get: function () {
    ...
    Object.defineProperty(CompatibilitySettings.prototype, "matchHorizontalTableIndentsToTextEdge", {
        get: function () {
            return this.compatibilityMode >= CompatibilityMode.Word2013;
        },
        enumerable: false,
    ...
    CompatibilitySettings.prototype.getActualLayoutInTableCell = function (anchorInfo) {
