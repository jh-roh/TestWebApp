...
exports.PaperSizeConverter = exports.PaperKind = void 0;
    ...
    PaperSizeConverter.calculatePaperKind = function (size, defaultValue, tolerance, badSizeDefaultValue) {
        ...
        for (var paperKind in PaperSizeConverter.paperSizeTable) {
            if (!Object.prototype.hasOwnProperty.call(PaperSizeConverter.paperSizeTable, paperKind))
                continue;
            var entSize = PaperSizeConverter.paperSizeTable[paperKind];
            if (Math.abs(size.width - entSize.width) <= tolerance && Math.abs(size.height - entSize.height) <= tolerance)
                return parseInt(paperKind);
        }
        return defaultValue;
    };
    PaperSizeConverter.paperSizeTable = (_a = {},
        _a[PaperKind.Letter] = new size_1.Size(12240, 15840),
        _a[PaperKind.LetterSmall] = new size_1.Size(12240, 15840),
        _a[PaperKind.Tabloid] = new size_1.Size(15840, 24480),
        _a[PaperKind.Ledger] = new size_1.Size(24480, 15840),
        _a[PaperKind.Legal] = new size_1.Size(12240, 20160),
        _a[PaperKind.Statement] = new size_1.Size(7920, 12240),
        _a[PaperKind.Executive] = new size_1.Size(10440, 15120),
        _a[PaperKind.A3] = new size_1.Size(16839, 23814),
        _a[PaperKind.A4] = new size_1.Size(11907, 16839),
        _a[PaperKind.A4Small] = new size_1.Size(11907, 16839),
        _a[PaperKind.A5] = new size_1.Size(8391, 11907),
        _a[PaperKind.B4] = new size_1.Size(14572, 20639),
        _a[PaperKind.B5] = new size_1.Size(10319, 14571),
        _a[PaperKind.Folio] = new size_1.Size(12240, 18720),
        _a[PaperKind.Quarto] = new size_1.Size(12189, 15591),
        _a[PaperKind.Standard10x14] = new size_1.Size(14400, 20160),
        _a[PaperKind.Standard11x17] = new size_1.Size(15840, 24480),
        _a[PaperKind.Note] = new size_1.Size(12240, 15840),
        _a[PaperKind.Number9Envelope] = new size_1.Size(5580, 12780),
        _a[PaperKind.Number10Envelope] = new size_1.Size(5940, 13680),
        _a[PaperKind.Number11Envelope] = new size_1.Size(6480, 14940),
        _a[PaperKind.Number12Envelope] = new size_1.Size(6840, 15840),
        _a[PaperKind.Number14Envelope] = new size_1.Size(7200, 16560),
        _a[PaperKind.CSheet] = new size_1.Size(24480, 31680),
        _a[PaperKind.DSheet] = new size_1.Size(31680, 48960),
        _a[PaperKind.ESheet] = new size_1.Size(48960, 63360),
        _a[PaperKind.DLEnvelope] = new size_1.Size(6237, 12474),
        _a[PaperKind.C5Envelope] = new size_1.Size(9185, 12984),
        _a[PaperKind.C3Envelope] = new size_1.Size(18369, 25965),
        _a[PaperKind.C4Envelope] = new size_1.Size(12983, 18369),
        _a[PaperKind.C6Envelope] = new size_1.Size(6463, 9184),
        _a[PaperKind.C65Envelope] = new size_1.Size(6463, 12983),
        _a[PaperKind.B4Envelope] = new size_1.Size(14173, 20013),
        _a[PaperKind.B5Envelope] = new size_1.Size(9978, 14173),
        _a[PaperKind.B6Envelope] = new size_1.Size(9978, 7087),
        _a[PaperKind.ItalyEnvelope] = new size_1.Size(6236, 13039),
        _a[PaperKind.MonarchEnvelope] = new size_1.Size(5580, 10800),
        _a[PaperKind.PersonalEnvelope] = new size_1.Size(5220, 9360),
        _a[PaperKind.USStandardFanfold] = new size_1.Size(21420, 15840),
        _a[PaperKind.GermanStandardFanfold] = new size_1.Size(12240, 17280),
        _a[PaperKind.GermanLegalFanfold] = new size_1.Size(12240, 18720),
        _a[PaperKind.IsoB4] = new size_1.Size(14173, 20013),
        _a[PaperKind.JapanesePostcard] = new size_1.Size(5669, 8391),
        _a[PaperKind.Standard9x11] = new size_1.Size(12960, 15840),
        _a[PaperKind.Standard10x11] = new size_1.Size(14400, 15840),
        _a[PaperKind.Standard15x11] = new size_1.Size(21600, 15840),
        _a[PaperKind.InviteEnvelope] = new size_1.Size(12472, 12472),
        _a[PaperKind.LetterExtra] = new size_1.Size(13680, 17280),
        _a[PaperKind.LegalExtra] = new size_1.Size(13680, 21600),
        _a[PaperKind.TabloidExtra] = new size_1.Size(16834, 25920),
        _a[PaperKind.A4Extra] = new size_1.Size(13349, 18274),
        _a[PaperKind.LetterTransverse] = new size_1.Size(12240, 15840),
        _a[PaperKind.A4Transverse] = new size_1.Size(11907, 16839),
        _a[PaperKind.LetterExtraTransverse] = new size_1.Size(13680, 17280),
        _a[PaperKind.APlus] = new size_1.Size(12869, 20183),
        _a[PaperKind.BPlus] = new size_1.Size(17291, 27609),
        _a[PaperKind.LetterPlus] = new size_1.Size(12240, 18274),
        _a[PaperKind.A4Plus] = new size_1.Size(11907, 18709),
        _a[PaperKind.A5Transverse] = new size_1.Size(8391, 11907),
        _a[PaperKind.B5Transverse] = new size_1.Size(10319, 14571),
        _a[PaperKind.A3Extra] = new size_1.Size(18255, 25228),
        _a[PaperKind.A5Extra] = new size_1.Size(9865, 13323),
        _a[PaperKind.B5Extra] = new size_1.Size(11395, 15647),
        _a[PaperKind.A2] = new size_1.Size(23811, 33676),
        _a[PaperKind.A3Transverse] = new size_1.Size(16839, 23814),
        _a[PaperKind.A3ExtraTransverse] = new size_1.Size(18255, 25228),
        _a[PaperKind.JapaneseDoublePostcard] = new size_1.Size(11339, 8391),
        _a[PaperKind.A6] = new size_1.Size(5953, 8391),
        _a[PaperKind.JapaneseEnvelopeKakuNumber2] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeKakuNumber3] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeChouNumber3] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeChouNumber4] = new size_1.Size(12240, 15840),
        _a[PaperKind.LetterRotated] = new size_1.Size(15840, 12240),
        _a[PaperKind.A3Rotated] = new size_1.Size(23814, 16839),
        _a[PaperKind.A4Rotated] = new size_1.Size(16839, 11907),
        _a[PaperKind.A5Rotated] = new size_1.Size(11907, 8391),
        _a[PaperKind.B4JisRotated] = new size_1.Size(20636, 14570),
        _a[PaperKind.B5JisRotated] = new size_1.Size(14570, 10318),
        _a[PaperKind.JapanesePostcardRotated] = new size_1.Size(8391, 5669),
        _a[PaperKind.JapaneseDoublePostcardRotated] = new size_1.Size(8391, 11339),
        _a[PaperKind.A6Rotated] = new size_1.Size(8391, 5953),
        _a[PaperKind.JapaneseEnvelopeKakuNumber2Rotated] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeKakuNumber3Rotated] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeChouNumber3Rotated] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeChouNumber4Rotated] = new size_1.Size(12240, 15840),
        _a[PaperKind.B6Jis] = new size_1.Size(7257, 10318),
        _a[PaperKind.B6JisRotated] = new size_1.Size(10318, 7257),
        _a[PaperKind.Standard12x11] = new size_1.Size(17280, 15840),
        _a[PaperKind.JapaneseEnvelopeYouNumber4] = new size_1.Size(12240, 15840),
        _a[PaperKind.JapaneseEnvelopeYouNumber4Rotated] = new size_1.Size(15840, 12240),
        _a[PaperKind.Prc16K] = new size_1.Size(8277, 12189),
        _a[PaperKind.Prc32K] = new size_1.Size(5499, 8561),
        _a[PaperKind.Prc32KBig] = new size_1.Size(5499, 8561),
        _a[PaperKind.PrcEnvelopeNumber1] = new size_1.Size(5783, 9354),
        _a[PaperKind.PrcEnvelopeNumber2] = new size_1.Size(5783, 9978),
        _a[PaperKind.PrcEnvelopeNumber3] = new size_1.Size(7087, 9978),
        _a[PaperKind.PrcEnvelopeNumber4] = new size_1.Size(6236, 11792),
        _a[PaperKind.PrcEnvelopeNumber5] = new size_1.Size(6236, 12472),
        _a[PaperKind.PrcEnvelopeNumber6] = new size_1.Size(6803, 13039),
        _a[PaperKind.PrcEnvelopeNumber7] = new size_1.Size(9071, 13039),
        _a[PaperKind.PrcEnvelopeNumber8] = new size_1.Size(6803, 17518),
        _a[PaperKind.PrcEnvelopeNumber9] = new size_1.Size(12983, 18369),
        _a[PaperKind.PrcEnvelopeNumber10] = new size_1.Size(18369, 25965),
        _a[PaperKind.Prc16KRotated] = new size_1.Size(12189, 8277),
        _a[PaperKind.Prc32KRotated] = new size_1.Size(8561, 5499),
        _a[PaperKind.Prc32KBigRotated] = new size_1.Size(8561, 5499),
        _a[PaperKind.PrcEnvelopeNumber1Rotated] = new size_1.Size(9354, 5783),
        _a[PaperKind.PrcEnvelopeNumber2Rotated] = new size_1.Size(9978, 5783),
        _a[PaperKind.PrcEnvelopeNumber3Rotated] = new size_1.Size(9978, 7087),
        _a[PaperKind.PrcEnvelopeNumber4Rotated] = new size_1.Size(11792, 6236),
        _a[PaperKind.PrcEnvelopeNumber5Rotated] = new size_1.Size(12472, 6236),
        _a[PaperKind.PrcEnvelopeNumber6Rotated] = new size_1.Size(13039, 6803),
        _a[PaperKind.PrcEnvelopeNumber7Rotated] = new size_1.Size(13039, 9071),
        _a[PaperKind.PrcEnvelopeNumber8Rotated] = new size_1.Size(17518, 6803),
        _a[PaperKind.PrcEnvelopeNumber9Rotated] = new size_1.Size(18369, 12983),
        _a[PaperKind.PrcEnvelopeNumber10Rotated] = new size_1.Size(25965, 18369),
        _a);
    return PaperSizeConverter;
}());
exports.PaperSizeConverter = PaperSizeConverter;
