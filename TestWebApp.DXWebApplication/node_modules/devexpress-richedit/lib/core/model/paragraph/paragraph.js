...
exports.Paragraph = exports.TabAlign = exports.TabsInfo = void 0;
...
var Paragraph = (function () {
    ...
    Paragraph.prototype.getNumerationCharacterProperties = function () {
        ...
        maskedParagraphRunProperties.setUseValueFull(enums_1.CharacterPropertiesMask.UseAll ^ enums_1.CharacterPropertiesMask.UseFontUnderlineType);
    ...
    Paragraph.prototype.getNumerationLanguageId = function () {
        var characterProperties = this.getNumerationCharacterProperties();
        if (!common_1.isDefined(characterProperties.langInfo))
            return "en";
        var langId = characterProperties.langInfo.latin;
        if (!common_1.isDefined(langId))
            return "en";
        return langId;
    };
    Paragraph.prototype.formatNumberingListText = function (formatString, args, levels) {
        ...
        var langId = this.getNumerationLanguageId();
        for (var i = 0; i < args.length; i++) {
            var converter = number_converter_creator_1.NumberConverterCreator.createConverter(levels[i].getListLevelProperties().format, this.subDocument.documentModel.simpleFormattersManager, langId);
            objArgs[i] = converter.convertNumber(args[i]);
        }
        try {
            return (_a = this.subDocument.documentModel.simpleFormattersManager).formatString.apply(_a, tslib_1.__spreadArray([formatString], objArgs));
        }
        catch (e) {
            try {
                return objArgs[0];
