...
exports.FieldContextMenuHelper = void 0;
...
var FieldContextMenuHelper = (function () {
    ...
    FieldContextMenuHelper.showHyperlinkItems = function (fields, interval) {
        return this.getHyperlinkFieldCore(fields, interval, function (field) { return field.getAllFieldInterval(); });
    };
    FieldContextMenuHelper.getHyperlinkField = function (fields, interval) {
        return this.getHyperlinkFieldCore(fields, interval, function (field) { return field.getAllFieldIntervalWithoutBorders(); });
    };
    FieldContextMenuHelper.getHyperlinkFieldCore = function (fields, interval, fieldIntervalGetter) {
        if (fields.length == 0)
            return null;
        var fieldIndex = Math.max(0, field_1.Field.normedBinaryIndexOf(fields, interval.start + 1));
        ...
        if (algorithms_1.IntervalAlgorithms.getIntersection(fieldIntervalGetter(field), interval))
            return FieldContextMenuHelper.getFinalResult(fields, interval, field);
        var parent = field.parent;
        if (parent) {
            if (algorithms_1.IntervalAlgorithms.getIntersection(fieldIntervalGetter(parent), interval))
                ...
                if (!field)
                    return null;
                return algorithms_1.IntervalAlgorithms.getIntersection(fieldIntervalGetter(field), interval) ? FieldContextMenuHelper.getFinalResult(fields, interval, field) : null;
            }
        }
