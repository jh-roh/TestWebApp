...
exports.FieldVisabilityInfo = exports.Field = exports.TcInfo = exports.SequenceInfo = exports.HyperlinkInfo = exports.FieldNameType = void 0;
...
var Field = (function () {
    ...
    Field.correctIntervalDueToFields = function (subDocument, newInterval) {
        ...
        list_1.ListUtils.forEach(fields, function (field) {
            if (field.getResultInterval().equals(newInterval) && !_this.isFloatingObjectSelected(subDocument, newInterval))
                newInterval.expand(field.getAllFieldInterval());
        }, indexesInterval.start, indexesInterval.end);
    };
    Field.isFloatingObjectSelected = function (subDocument, interval) {
        if (interval.length !== 1)
            return false;
        var run = subDocument.getRunByPosition(interval.start);
        return run && (run.getType() == run_type_1.RunType.AnchoredPictureRun || run.getType() == run_type_1.RunType.AnchoredTextBoxRun);
    };
