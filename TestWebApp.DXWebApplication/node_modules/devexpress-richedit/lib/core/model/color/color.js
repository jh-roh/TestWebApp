...
var ColorHelper = (function () {
    ...
    ColorHelper.getCssStringInternal = function (color) {
        ...
        switch (alpfa) {
            ...
            default: return "rgba(" + color_1.ColorUtils.getRed(color) + "," + color_1.ColorUtils.getGreen(color) + "," + color_1.ColorUtils.getBlue(color) + "," + ColorHelper.getOpacity(color) + ")";
        }
    };
    ColorHelper.getOpacity = function (color) {
        return color_1.ColorUtils.getAlpha(color) / 255;
    };
