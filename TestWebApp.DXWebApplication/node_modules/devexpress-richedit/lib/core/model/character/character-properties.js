...
exports.MaskedCharacterProperties = exports.CharacterProperties = void 0;
...
var MaskedCharacterProperties = (function (_super) {
    ...
    MaskedCharacterProperties.prototype.calculateHash = function () {
        return _super.prototype.calculateHash.call(this) +
            ...
            math_1.MathUtils.somePrimes[16] * this.useValueExt;
    };
    ...
    MaskedCharacterProperties.prototype.setUseValueFull = function (value) {
        this.useValue = this.getLowPartUseValue(value);
        this.useValueExt = this.getHighPartUseValue(value);
    };
    MaskedCharacterProperties.prototype.getLowPartUseValue = function (value) {
        return value | 0;
    };
    MaskedCharacterProperties.prototype.getHighPartUseValue = function (value) {
        if (value < MaskedCharacterProperties.denominator)
            return 0;
        if (!Math.trunc) {
    ...
    MaskedCharacterProperties.prototype.getUseValueFull = function () {
        return this.useValue + this.useValueExt * MaskedCharacterProperties.denominator;
    };
    MaskedCharacterProperties.prototype.resetAllUse = function () {
        this.setUseValue(enums_1.CharacterPropertiesMask.UseAll, false);
    };
    MaskedCharacterProperties.prototype.setAllUse = function () {
        this.setUseValue(enums_1.CharacterPropertiesMask.UseAll, true);
    };
