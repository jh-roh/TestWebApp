...
exports.ConstRangePermission = exports.RangePermission = void 0;
...
var RangePermission = (function (_super) {
    ...
    RangePermission.prototype.equals = function (obj) {
        return _super.prototype.equals.call(this, obj) && (string_1.StringUtils.isNullOrEmpty(this.userName) ? this.group == obj.group : this.userName == obj.userName);
    };
