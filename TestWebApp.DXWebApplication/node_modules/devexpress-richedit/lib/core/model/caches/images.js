...
var CacheImageInfo = (function () {
    ...
    Object.defineProperty(CacheImageInfo.prototype, "pdfCompatibleBase64", {
        get: function () { var _a; return (_a = this._convertedBase64) !== null && _a !== void 0 ? _a : this.base64; },
        enumerable: false,
        configurable: true
    });
    ...
    CacheImageInfo.prototype.equals = function (obj) {
        return (common_1.isDefined(this._referenceInfo) && this._referenceInfo === obj._referenceInfo) ||
    ...
    CacheImageInfo.prototype.shouldMakeImagePdfCompatible = function () {
        if (common_1.isDefined(this._convertedBase64))
            return false;
        return !this.isPdfCompatible();
    };
    CacheImageInfo.prototype.isPdfCompatible = function () {
        if (common_1.isDefined(this._convertedBase64))
            return true;
        if (common_1.isDefined(this.base64)) {
            var data = this.getImageHeader();
    ...
    CacheImageInfo.prototype.setPdfCompatibleBase64 = function (val) {
        this._convertedBase64 = base64_1.Base64Utils.normalizeToDataUrl(val, "image/png");
    };
    CacheImageInfo.prototype.getImageHeader = function () {
        var match = /^data:.+;base64,(.*)$/.exec(this.base64);
        var header = match[1].substring(0, 8);
