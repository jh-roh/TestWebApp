...
exports.AlphaModulationColorTransform = void 0;
...
var AlphaModulationColorTransform = (function (_super) {
    tslib_1.__extends(AlphaModulationColorTransform, _super);
    ...
    AlphaModulationColorTransform.prototype.applyTransform = function (color) {
        var normalAlpha = this.toDoubleValue(color_1.ColorUtils.getAlpha(color)) * this.value / drawing_value_constants_1.DrawingValueConstants.ThousandthOfPercentage;
        return dx_color_1.DXColor.fromArgb(this.toIntValue(normalAlpha), color);
    };
    return AlphaModulationColorTransform;
}(color_transform_value_base_1.ColorTransformValueBase));
exports.AlphaModulationColorTransform = AlphaModulationColorTransform;
