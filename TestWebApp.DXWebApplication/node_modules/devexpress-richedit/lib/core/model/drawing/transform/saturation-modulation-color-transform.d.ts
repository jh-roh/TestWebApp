...
export declare class SaturationModulationColorTransform extends ColorTransformValueBase {
    clone(): ColorTransformBase;
    applyTransform(color: number): number;
}
//# sourceMappingURL=saturation-modulation-color-transform.d.ts.map