export declare enum DrawingEffectContainerType {
    Sibling = 0,
    Tree = 1
}
export declare enum DrawingUnderlineFillType {
    Fill = 0,
    FollowsText = 1
}
export declare enum DrawingFillType {
    Automatic = 0,
    None = 1,
    Solid = 2,
    Gradient = 3,
...
export declare enum DrawingBulletType {
    Automatic = 0,
    Color = 1,
    Size = 2,
    Typeface = 3,
...
export declare enum DrawingStrokeUnderlineType {
    Automatic = 0,
    Outline = 1,
    FollowsText = 2
}
export declare enum PresetCameraType {
    None = 0,
...
export declare enum LightRigDirection {
    None = 0,
    Bottom = 1,
    BottomLeft = 2,
    BottomRight = 3,
...
export declare enum LightRigPreset {
    None = 0,
    LegacyFlat1 = 1,
    LegacyFlat2 = 2,
    LegacyFlat3 = 3,
...
export declare enum PresetMaterialType {
    None = 0,
    LegacyMatte = 1,
    LegacyPlastic = 2,
    LegacyMetal = 3,
...
export declare enum DrawingText3DType {
    Automatic = 0,
    Shape3D = 1,
    FlatText = 2
}
export declare enum PresetBevelType {
    None = 0,
    RelaxedInset = 1,
    Circle = 2,
    Slope = 3,
