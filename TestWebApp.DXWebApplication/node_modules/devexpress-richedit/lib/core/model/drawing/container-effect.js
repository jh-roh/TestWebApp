...
exports.ContainerEffect = void 0;
var drawing_effect_collection_1 = require("./drawing-effect-collection");
var ContainerEffect = (function () {
    function ContainerEffect() {
        this.name = "";
        this.hasEffectsList = true;
        this.effects = new drawing_effect_collection_1.DrawingEffectCollection();
    }
...
exports.ContainerEffect = ContainerEffect;
