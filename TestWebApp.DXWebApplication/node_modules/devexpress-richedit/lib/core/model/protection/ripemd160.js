...
var RIPEMD160 = (function () {
    ...
    RIPEMD160.prototype.computeHashCore = function (M) {
        var offset = 0;
        for (var i = 0; i < 16; i++) {
    ...
    RIPEMD160.prototype.f1 = function (x, y, z) {
        return ((x) ^ (y) ^ (z));
    };
    RIPEMD160.prototype.f2 = function (x, y, z) {
        return (((x) & (y)) | ((~x) & (z)));
    };
    RIPEMD160.prototype.f3 = function (x, y, z) {
        return (((x) | (~(y))) ^ (z));
    };
    RIPEMD160.prototype.f4 = function (x, y, z) {
        return (((x) & (z)) | ((y) & (~(z))));
    };
    RIPEMD160.prototype.f5 = function (x, y, z) {
        return ((x) ^ ((y) | (~(z))));
    };
    RIPEMD160.prototype.rotl = function (x, n) {
        return (x << n) | (x >>> (32 - n));
    };
    RIPEMD160.prototype.resetCache = function () {
        this._hash = [0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0];
    };
    RIPEMD160.prototype.computeHash = function (source) {
        this.resetCache();
