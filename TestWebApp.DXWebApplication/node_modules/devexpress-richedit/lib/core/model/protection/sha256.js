...
var SHA256 = (function () {
    ...
    SHA256.prototype.computeHashCore = function (words) {
        ...
        for (var i = 0; i < 64; i++) {
            if (i < 16) {
                ...
                var gamma0x = temp[i - 15];
                var gamma0 = ((gamma0x << 25) | (gamma0x >>> 7)) ^
                    ((gamma0x << 14) | (gamma0x >>> 18)) ^
                    (gamma0x >>> 3);
                var gamma1x = temp[i - 2];
            ...
            var t1 = h + sigma1 + ch + constants[i] + temp[i];
            var t2 = sigma0 + maj;
            h = g;
            g = f;
            f = e;
