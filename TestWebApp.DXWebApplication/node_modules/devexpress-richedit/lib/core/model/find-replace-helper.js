...
exports.BackwardCharacterIterator = exports.ForwardCharacterIterator = exports.CharacterIteratorBase = exports.FindReplaceHelper = exports.SearchDirection = exports.FindReplaceState = void 0;
...
var FindReplaceHelper = (function () {
    ...
    FindReplaceHelper.prototype.shouldSkipSearchInterval = function (subDocumentId, interval) {
        if (!common_1.isDefined(this.modelManager.richOptions.search.filterInterval))
            return false;
