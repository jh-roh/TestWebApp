...
exports.CharacterPropertiesManipulator = void 0;
...
var CharacterPropertiesManipulator = (function (_super) {
    ...
    function CharacterPropertiesManipulator(manipulator) {
        ...
        _this.fontSmallCaps = new MaskedCharacterPropertiesManipulator(manipulator, character_property_descriptor_1.CharacterPropertyDescriptor.smallCaps);
...
var CharacterPropertiesUseValueManipulator = (function () {
    ...
    CharacterPropertiesUseValueManipulator.prototype.setValue = function (subDocument, interval, newValue) {
        ...
        while (iterator.moveNext()) {
            var run = iterator.currentRun;
            oldState.register(new history_item_state_object_1.HistoryItemIntervalStateObject(iterator.currentInterval(), run.maskedCharacterProperties.getUseValueFull()));
