...
exports.SpellCheckerIntervalsManager = void 0;
...
var SpellCheckerIntervalsManager = (function () {
    ...
    SpellCheckerIntervalsManager.prototype.reset = function () {
    ...
    SpellCheckerIntervalsManager.prototype.getIntervalsToCheck = function () {
        ...
        var maxRequestLength = this.subDocument.documentModel.modelOptions.maxSpellRequestLength;
