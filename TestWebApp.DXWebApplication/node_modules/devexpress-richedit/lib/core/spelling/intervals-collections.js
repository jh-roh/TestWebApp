...
exports.IgnoredWordsCollection = exports.IgnoredIntervalCollection = exports.MisspelledIntervalCollection = exports.UncheckedIntervalCollection = exports.SpellCheckerIntervalCollection = void 0;
...
var SpellCheckerIntervalCollection = (function () {
    ...
    SpellCheckerIntervalCollection.prototype.deleteIntervalsByPositions = function (start, end, strictMatch) {
        var _this = this;
        if (strictMatch === void 0) { strictMatch = false; }
        var defInterval = fixed_1.FixedInterval.fromPositions(start, end);
        if (strictMatch) {
            list_1.ListUtils.anyOf(this.intervals, function (value, index) {
                var isIntervalsEqual = defInterval.equals(value);
                if (isIntervalsEqual)
                    _this.remove(index);
    ...
    SpellCheckerIntervalCollection.prototype.clear = function () {
        this.intervals = [];
    };
...
var IgnoredWordsCollection = (function () {
    ...
    IgnoredWordsCollection.prototype.clear = function () {
        this.ignoredWords = [];
    };
