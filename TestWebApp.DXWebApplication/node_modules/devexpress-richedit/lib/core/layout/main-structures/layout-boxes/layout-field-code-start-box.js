...
exports.LayoutFieldCodeStartBox = void 0;
...
var LayoutFieldCodeStartBox = (function (_super) {
    tslib_1.__extends(LayoutFieldCodeStartBox, _super);
    ...
    LayoutFieldCodeStartBox.prototype.getType = function () {
        return layout_box_1.LayoutBoxType.FieldCodeStart;
    };
    ...
    LayoutFieldCodeStartBox.prototype.pushInfoForMeasure = function (info, _showHiddenSymbols) {
        info.push(new measure_info_1.MeasureInfoNonText(this.getBoxChar(), this.characterProperties));
    };
    ...
    LayoutFieldCodeStartBox.prototype.renderGetContent = function (_renderer) {
        return encode_1.EncodeUtils.encodeHtml(this.getBoxChar());
    };
...
exports.LayoutFieldCodeStartBox = LayoutFieldCodeStartBox;
